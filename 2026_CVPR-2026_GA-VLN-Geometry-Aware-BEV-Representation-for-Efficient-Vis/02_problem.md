...
- Abstract problem cue: Despite significant progress in Vision-Language Navigation (VLN), existing approaches still rely on dense RGB videos that produce excessive patch tokens and lack explicit spatial ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Navigation, geometry, BEV` 관점의 개선을 제안한다.

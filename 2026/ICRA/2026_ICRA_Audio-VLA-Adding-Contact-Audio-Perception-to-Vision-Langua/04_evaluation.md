...
- **p. 6 / IV. EXPERIMENT - extractive PDF cue:** The performance gap reveals that in tasks requiring precise force control and continuous state monitoring, visual modality nearly loses its ability to perceive contact states ...
- **p. 5 / IV. EXPERIMENT - extractive PDF cue:** [27], domain shift is implemented by randomly varying lighting conditions and desktop surface material colors throughout the environments. b) Real-world setup: The real-world experimental setup ...
- **p. 5 / IV. EXPERIMENT - extractive PDF cue:** 3: Experimental setup showing the hardware platform and real-world manipulation tasks of contact audio feedback: Erasing All Whiteboard Marks (EAWM) and Scooping 5 Grams of ...
- **p. 7 / IV. EXPERIMENT - extractive PDF cue:** The doubling of EAWM success rates after LoRA finetuning [26] and consistent improvements across both simulation and real-world experiments demonstrate that LoRA [26] is particularly ...
...
- **p. 6 / IV. EXPERIMENT - extractive PDF cue:** AudioVLA preserves 30% and 20% success rates on EAWM and S5GO respectively, whereas vision-only methods approach near-zero performance.
- **p. 7 / IV. EXPERIMENT - extractive PDF cue:** The inferior performance of the vision-only configuration compared to the full configuration demonstrates that audio provides critical information for TABLE IV: Ablation study results on ...
...
- **p. 1 / Figure/Table caption - extractive PDF cue:** Fig. 1: Unlike VLA models, Audio-VLA incorporates audio perception, enabling better assessment of contact states and understanding of manipulation dynamics. events [13] and interaction feedback ...
...
- **p. 5 / Figure/Table caption - extractive PDF cue:** Fig. 3: Experimental setup showing the hardware platform and real-world manipulation tasks of contact audio feedback: Erasing All Whiteboard Marks (EAWM) and Scooping 5 Grams ...
...
- **p. 5 / IV. EXPERIMENT - extractive PDF cue:** Visual data is captured at 480×640 resolution, while two piezoelectric contact microphones mounted on both sides of the gripper record audio at 44.1kHz sampling rate.
...
- **p. 3 / III. METHOD - extractive PDF cue:** I(·) t ∈RB×3×H×W denotes the raw RGB images from different camera viewpoints at timestep t, with B representing the batch size, H = W representing ...
- **p. 3 / III. METHOD - extractive PDF cue:** In the Frequency BSpline Projection (FBSP) layer [25], we reduced both the hop length and window length to enhance temporal resolution while maintaining sufficient frequency ...
...
- **p. 7 / V. CONCLUSION - extractive PDF cue:** Experimental results demonstrate that Audio-VLA achieves superior performance in both simulation environments and real-world tasks, proving the contribution of contact audio perception in overcoming visual ...
- **p. 6 / IV. EXPERIMENT - extractive PDF cue:** Audio-VLA overcomes these limitations through acoustic signatures of interaction physics.

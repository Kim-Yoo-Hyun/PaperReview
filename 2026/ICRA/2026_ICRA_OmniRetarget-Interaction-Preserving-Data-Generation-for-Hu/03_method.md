...
- **p. 1 / I. INTRODUCTION - extractive PDF cue:** To address these challenges, imitating human motions offers a powerful alternative for learning whole-body control, especially for complex scene interactions.
...
|---|---|---|---|
| Input/observation | address, challenges, imitating, human, motions, offers, powerful, alternative, learning, whole-body, control, especially, complex, scene | proprioception, reference pose/motion, visual or language command | body cue; exact tensor/frame verify |
| State/latent | address, challenges, imitating, human, motions, offers, powerful, alternative, learning, whole-body | whole-body pose, balance/contact state와 skill/mode | body cue; notation verify |
| Action/output | high-quality, data, enables, proprioceptive, policies, successfully, execute, longhorizon, seconds, parkour | joint/whole-body action, motion target 또는 task trajectory | body cue; unit/decoder verify |
...
| Rate / latency | motion policy/WBC/torque loop의 계층별 rate; numeric value 확인 필요. | Demonstrated behaviors include (a) 30-second parkour course involving chair moving, stepping & vault, and jump & roll, (b) object transportation, (c) crawling ... | Hz/fps, inference time and control rate |
...
- **p. 1 / Abstract - extractive PDF cue:** All code, retargeted datasets, and trained policies will be publicly released.
...
- **PDF anchors reviewed:** method p. 1 (Abstract), p. 1 (I. INTRODUCTION), objective p. 1 (Abstract), p. 1 (I. INTRODUCTION), temporal p. 1 (Front matter), p. 1 (Front matter).

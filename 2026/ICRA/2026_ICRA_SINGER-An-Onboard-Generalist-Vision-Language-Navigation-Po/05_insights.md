...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: In this work, we present SINGER for language-guided autonomous drone navigation in the open world using only onboard sensing and compute.
- 출발 문제 단서: Despite these successes, open-vocabulary autonomous drone navigation remains an unsolved challenge due to the scarcity of largescale demonstrations, real-time control demands of drones for stabilization, and lack of ...
- 주장된 효과 단서: Through extensive hardware flight experiments, we demonstrate superior zero-shot sim-to-real transfer of our policy to unseen environments and unseen language-conditioned goal objects.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: Through extensive hardware flight experiments, we demonstrate superior zero-shot sim-to-real transfer of our policy to unseen environments and unseen language-conditioned goal objects.
...
## 근거가 되는 논문 단서
- Problem cue: Despite these successes, open-vocabulary autonomous drone navigation remains an unsolved challenge due to the scarcity of largescale demonstrations, real-time control demands of drones for stabilization, and lack of ...

...
- **p. 3 / III. METHODOLOGY - extractive body cue:** Preprocessing Prior to processing, PPS-based hardware synchronization is applied and the thermal camera-LiDAR intrinsics/extrinsics are calibrated.
...
- **p. 3 / III. METHODOLOGY - extractive body cue:** To improve global geometric accuracy and robustness in dynamic scenarios, we perform a LiDARplane-constrained bundle adjustment (BA) that jointly refines camera poses and triangulated 3D ...
...
- **p. 5 / Figure/Table caption - extractive body cue:** Fig. 3. Comparison of renderings on private datasets. Data collection times (left to right) are 12:00 p.m., 10:00 p.m., 2:00 p.m., 7:00 p.m., and 6:00 ...
...
- **p. 1 / Figure/Table caption - extractive body cue:** Fig. 1. Hardware setup of LIT-GS. (a1) thermal observations of the FAST-Calib target under strong sunlight; (a2) thermal observations of the camera's internal reference target; ...
- **p. 2 / Figure/Table caption - extractive body cue:** Fig. 2. System overview of LIT-GS. • We propose LIT-GS, a LiDAR-inertial-thermal Gaus- sian Splatting framework that couples LiDAR plane constraints into both pose/structure refinement ...
- **p. 5 / Figure/Table caption - extractive body cue:** Fig. 3. Comparison of renderings on private datasets. Data collection times (left to right) are 12:00 p.m., 10:00 p.m., 2:00 p.m., 7:00 p.m., and 6:00 ...
- **p. 6 / Figure/Table caption - extractive body cue:** Fig. 4. Comparison of renderings on public datasets. and distorted surface structures in LIV-GaussMap. Similarly, in the Tree-stump scene, the reconstructed trunk surfaces appear noticeably ...
...
- **Evidence anchors reviewed:** datasets p. 3 (III. METHODOLOGY), p. 3 (III. METHODOLOGY), metrics p. 3 (III. METHODOLOGY), p. 3 (III. METHODOLOGY), p. 5 (Figure/Table caption), p. 6 (Figure/Table caption), baselines p. 7 (Figure/Table caption), p. 5 (Figure/Table caption), p. 6 (Figure/Table caption), results p. 3 (III. METHODOLOGY), p. 3 (III. METHODOLOGY).

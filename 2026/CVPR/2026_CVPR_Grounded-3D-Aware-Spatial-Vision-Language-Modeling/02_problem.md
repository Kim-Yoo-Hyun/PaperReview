# Problem - Grounded 3D-Aware Spatial Vision-Language Modeling
...
PDF body framing (p. 2 (1. Introduction), p. 2 (1. Introduction)): Two challenges, in particular, are under-addressed.
...
| Objective / loss / cost | geometric/semantic reconstruction or matching loss; cue terms: token, detached, computation, graph, gradient, flows, through, serves | p. 4 (2.2.2. Implicit 2D Grounding) |
...
|---|---|---|
| body cue at p. 6 | This makes its 3D predictions unstable under changes in image size. | reported limitation/failure wording; scope must be verified |
| body cue at p. 6 | In contrast, Stage 2 finetuning focuses on learning the structure of CoT reasoning, and the results indicate that ... | reported limitation/failure wording; scope must be verified |

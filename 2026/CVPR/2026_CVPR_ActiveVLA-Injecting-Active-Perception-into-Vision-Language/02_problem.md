...
- Abstract problem cue: However, most existing approaches overlook the importance of active perception: they typically rely on static, wrist-mounted cameras that provide an end-effector-centric viewpoint.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, active perception, 3D manipulation` 관점의 개선을 제안한다.

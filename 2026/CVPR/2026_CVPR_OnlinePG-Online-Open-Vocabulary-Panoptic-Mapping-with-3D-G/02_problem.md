...
- Abstract problem cue: However, existing methods are predominantly offline or lack instance-level understanding, limiting their applicability to real-world robotic tasks.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, semantic mapping, open-vocabulary` 관점의 개선을 제안한다.

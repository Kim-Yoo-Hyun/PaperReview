...
- Abstract problem cue: While recent efforts have introduced multi-view geometry transformers into VLMs, they typically fuse only the deep-layer features from vision and geometry encoders, discarding rich ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `geometry, VLM, spatial reasoning` 관점의 개선을 제안한다.

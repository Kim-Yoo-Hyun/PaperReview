...
- **Claim/result cue:** Building upon this framework, we develop VLM-SpatialStack, a model that achieves state-of-the-art performance on multiple 3D spatial reasoning benchmarks.
...
- **Registry interface:** `geometry, VLM, spatial reasoning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Vision-Language Understanding`; tags: `geometry, VLM, spatial reasoning`.

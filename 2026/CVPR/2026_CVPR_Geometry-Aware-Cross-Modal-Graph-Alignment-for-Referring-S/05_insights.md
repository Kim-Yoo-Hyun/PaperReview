...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: To address this, we propose GeoCGA, a geometry-aware cross-modal graph alignment framework that bridges linguistic semantics with the 3DGS representation.
- 출발 문제 단서: Recent advances in 3D Gaussian Splatting (3DGS) have provided a promising foundation for this problem, as the representation allows for efficient, differentiable rendering of continuous 3D scenes with ...
- 주장된 효과 단서: GeoCGA consistently outperforms prior state-of-the-art methods, yielding relative mIoU improvements of 20.8% on Ref-LERF, 5.7% on LERF-OVS, and 1.0% on 3D-OVS.
...
- Result cue: GeoCGA consistently outperforms prior state-of-the-art methods, yielding relative mIoU improvements of 20.8% on Ref-LERF, 5.7% on LERF-OVS, and 1.0% on 3D-OVS.

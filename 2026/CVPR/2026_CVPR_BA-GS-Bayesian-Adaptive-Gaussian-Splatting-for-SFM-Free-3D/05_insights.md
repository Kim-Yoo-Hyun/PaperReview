...
- **Claim/result cue:** Experiments across multiple benchmark datasets including Tanks and Temples, MVimgNet, and LLFF demonstrate that our method consistently outperforms existing approaches.
...
- Registry position: `3D Geometry, Registration, and Equivariance`; tags: `Gaussian Splatting, 3D reconstruction, geometry, 3D Vision`.

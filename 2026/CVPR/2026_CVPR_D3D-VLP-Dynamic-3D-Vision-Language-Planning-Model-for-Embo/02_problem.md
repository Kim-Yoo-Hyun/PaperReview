...
- Abstract problem cue: Embodied agents face a critical dilemma that end-to-end models lack interpretability and explicit 3D reasoning, while modular systems ignore cross-component interdependencies and synergies.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Vision, Vision-Language, Planning, Navigation` 관점의 개선을 제안한다.

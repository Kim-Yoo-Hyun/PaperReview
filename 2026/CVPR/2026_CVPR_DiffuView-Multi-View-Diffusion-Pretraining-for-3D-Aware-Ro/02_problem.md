...
- Abstract problem cue: Robotic manipulation from visual observations remains challenging due to the lack of 3D consistent representations that can generalize across diverse viewpoints and sensor configurations.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Diffusion, 3D manipulation, Robotics` 관점의 개선을 제안한다.

...
- **p. 6 / 4.1. Experimental Setup - extractive body cue:** We evaluate on 40 unseen ScanNet scenes, and further examine the model's zero-shot generalization on the MipNeRF360 [1] dataset.
- **p. 6 / 4.1. Experimental Setup - extractive body cue:** Dataset For evaluating both 3D scene and semantic field reconstruction, our model is trained on a combined dataset of ScanNet++ [41] and ScanNet [6], totaling ...
- **p. 7 / 0.724 17.28 13.31 ≈60min - extractive body cue:** Quantitative comparisons of novel view synthesis on the RE10k [46] and ACID [22] dataset under 2-views setup.
- **p. 7 / 0.724 17.28 13.31 ≈60min - extractive body cue:** 3, Uni3R outperforms pose-dependent methods, such as PixelSplat and MVSplat, by a clear margin (1.7dB), and slightly surpasses baseline model NoPoSplat with a gain of ...
- **p. 8 / 0.724 17.28 13.31 ≈60min - extractive body cue:** Comparison with 4 and 8-view settings on the RE10k [46] and ScanNet [6] datasets.
- **p. 8 / 0.724 17.28 13.31 ≈60min - extractive body cue:** Zero-shot generalization on Mip-NeRF360 [1] dataset View Nums PSNR↑SSIM↑LPIPS↓mIoU↑Acc↑ rel↓
...
- **p. 6 / 4.2. Experiment Results - extractive body cue:** The underlying multi-view geometry acts as a spatial filter that ‘votes out' inconsistent 2D errors.
...
- **p. 1 / Figure/Table caption - extractive body cue:** Figure 1. Uni3R takes unposed arbitrary multi-view images as input and produces a unified 3D Gaussian scene representation, enabling state-of-the-art performance in view synthesis, semantic ...
- **p. 3 / Figure/Table caption - extractive body cue:** Figure 2. Architectural overview of the Uni3R pipeline. Uni3R predicts a set of Gaussian primitives with jointly integrated geometry, appearance, and open-vocabulary semantics in a ...
- **p. 5 / Figure/Table caption - extractive body cue:** Figure 3. Qualitative comparison of novel view synthesis on RealEstate10k test set with 8 input images.
...
- **p. 7 / Figure/Table caption - extractive body cue:** Table 2. Comparison with Per-Scene Optimized Methods. Time corresponds to the average reconstruction time per scene. Images GT LSeg Feature 3DGS LSM Uni3R (Ours) Wall
- **p. 7 / Figure/Table caption - extractive body cue:** Figure 4. Qualitative Comparison of Novel-View Segmentation on ScanNet. RE10k ACID
- **p. 7 / Figure/Table caption - extractive body cue:** Table 3. Quantitative comparisons of novel view synthesis on the RE10k [46] and ACID [22] dataset under 2-views setup. Novel-View Synthesis As shown in Tab. ...
- **p. 8 / Figure/Table caption - extractive body cue:** Table 4. Comparison with 4 and 8-view settings on the RE10k [46] and ScanNet [6] datasets. 2View 8View
...
- **p. 6 / 3.3. Training Objectives - extractive body cue:** Time↓ Source View Target View Method SfM Per-Scene mIoU↑Acc.↑ rel↓ τ ↑ mIoU↑Acc.↑PSNR↑SSIM↑LPIPS↓ LSeg N/A N/A 0.4701 0.7891 - - 0.4819 0.7927 - - - ...

...
- **Claim/result cue:** More recently, a few approaches have explored embedding semantic features into each Gaussian via matching, which optimizes costs and achieves strong results.

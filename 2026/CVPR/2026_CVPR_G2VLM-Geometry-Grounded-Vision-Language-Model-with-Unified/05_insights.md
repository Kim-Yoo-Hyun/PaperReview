...
- **Registry interface:** `VLM, 3D reconstruction, spatial reasoning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Vision-Language Understanding`; tags: `VLM, 3D reconstruction, spatial reasoning`.

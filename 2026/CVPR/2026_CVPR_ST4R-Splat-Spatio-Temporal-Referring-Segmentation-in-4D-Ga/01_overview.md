...
## Main Claims
- Evaluated on our newly constructed STRS-4DGS benchmark, our method significantly outperforms adapted state-of-the-art baselines across both timeagnostic and time-sensitive metrics, establishing a strong foundation for language-driven 4D scene ...
...
## Abstract Cue
- Understanding objects in dynamic 4D environments via natural language is crucial yet underexplored.

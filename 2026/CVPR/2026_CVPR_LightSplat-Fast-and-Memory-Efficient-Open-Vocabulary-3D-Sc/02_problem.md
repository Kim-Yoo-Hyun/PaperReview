...
- Abstract problem cue: However, existing approaches remain slow, memory-intensive, and overly complex due to iterative optimization and dense per-Gaussian feature assignments.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, open-vocabulary, efficiency` 관점의 개선을 제안한다.

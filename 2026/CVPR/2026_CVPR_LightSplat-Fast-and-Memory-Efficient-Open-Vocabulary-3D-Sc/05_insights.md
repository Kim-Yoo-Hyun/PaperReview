...
- **Claim/result cue:** As a result, LightSplat achieves state-of-the-art performance with up to 50-400× speedup and 64× lower memory, enabling scalable language-driven 3D understanding.
...
- **Registry interface:** `Gaussian Splatting, open-vocabulary, efficiency` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Language-Grounded 3D Scene Representations`; tags: `Gaussian Splatting, open-vocabulary, efficiency`.

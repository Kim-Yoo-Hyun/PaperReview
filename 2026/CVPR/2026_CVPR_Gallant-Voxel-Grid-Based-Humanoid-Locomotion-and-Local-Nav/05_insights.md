...
- **Claim/result cue:** Gallant also firstly achieves over-90% success rates in challenging scenarios such as stair climbing and stepping onto elevated platforms through improved end-to-end optimization.
...
- **Registry interface:** `Robotics, humanoid, perceptive locomotion, LiDAR, 3D navigation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Locomotion, Whole-Body, and Mobile Manipulation`; tags: `Robotics, humanoid, perceptive locomotion, LiDAR, 3D navigation`.

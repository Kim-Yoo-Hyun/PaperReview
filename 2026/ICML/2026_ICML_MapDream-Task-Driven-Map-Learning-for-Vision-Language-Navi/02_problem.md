...
- Abstract problem cue: Vision-Language Navigation (VLN) requires agents to follow natural language instructions in partially observed 3D environments, motivating map representations that aggregate spatial context beyond local ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model, Navigation` 관점의 개선을 제안한다.

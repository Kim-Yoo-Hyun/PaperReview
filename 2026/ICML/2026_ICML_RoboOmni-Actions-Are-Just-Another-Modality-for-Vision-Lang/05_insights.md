...
- **Claim/result cue:** Extensive evaluations on the CALVIN, SimplerEnv, and realworld platforms confirm that RoboOmni establishes new state-of-the-art performance, significantly outperforming diffusion-based baselines such as π0 .
...
- **Registry interface:** `Vision-Language Model, Robotics` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `Vision-Language Model, Robotics`.

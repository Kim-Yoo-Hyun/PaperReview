...
- **Claim/result cue:** Introduction Meanwhile, recent advances (Li et al., 2025c; Huang et al., 2025; Wang et al., 2025b; Lan et al., 2025; Zhuo et al., 2025; Yuan et al., 2026) ...
...
- **Registry interface:** `Gaussian Splatting, 3D reconstruction, semantic, alignment, 3D Vision` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Vision-Language Understanding`; tags: `Gaussian Splatting, 3D reconstruction, semantic, alignment, 3D Vision`.

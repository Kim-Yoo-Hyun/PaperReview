...
- Abstract problem cue: Neural scene representations achieve high-fidelity rendering by encoding 3D scenes as continuous functions, but their latent spaces are typically implicit and globally entangled, making ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `NeRF, equivariant, 3D Vision` 관점의 개선을 제안한다.

...
- **Registry interface:** `NeRF, equivariant, 3D Vision` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Registration, and Equivariance`; tags: `NeRF, equivariant, 3D Vision`.

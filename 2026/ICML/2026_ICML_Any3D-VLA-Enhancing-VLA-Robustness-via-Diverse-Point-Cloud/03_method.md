...
- **PDF anchors reviewed:** method p. 4 (5.1. Overall Architecture), p. 4 (5.1. Overall Architecture), p. 5 (5.3. Training Strategy), p. 5 (5.3. Training Strategy), objective p. 5 (5.3. Training Strategy), p. 5 (5.3. Training Strategy), p. 4 (5.1. Overall Architecture), temporal p. 8 (0.3 FPS), p. 8 (0.3 FPS), p. 3 (3. Dataset and Benchmark), p. 6 (6.1.1. REAL-WORLD SETUP), p. 6 (6.1.1. REAL-WORLD SETUP), p. 7 (0.5 FPS).

...
- Paper: https://openreview.net/forum?id=HFNJOpXHfm
...
## Paper-Specific Cues
- Topic cue: We present WorldMirror, a unified feed-forward model for comprehensive 3D geometric prediction tasks.
- Method cue: We present WorldMirror, a unified feed-forward model for comprehensive 3D geometric prediction tasks.
- Result cue: WorldMirror achieves state-of-the-art performance across diverse benchmarks from camera, point map, depth, and surface normal estimation to novel view synthesis, while maintaining the efficiency ...
...
- 초록에서 확인되는 주요 cue: WorldMirror, Unlike, Gaussians, Remarkably, Code, Tencent-Hunyuan, HunyuanWorld-Mirror.

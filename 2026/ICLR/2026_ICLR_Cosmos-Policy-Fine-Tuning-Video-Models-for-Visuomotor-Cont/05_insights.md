...
- **Registry interface:** `Robotics, world model, visuomotor control, video model` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
- Reuse the paper by preserving its input/output boundary and testing downstream success, failure, and latency under a matched baseline budget.

### Dependency and evolution

- Registry position: `World Models, Safety, and Recovery`; tags: `Robotics, world model, visuomotor control, video model`.
...
고정된 sensor·compute budget에서 Robotics, world model, visuomotor control, video model 기반 표현이 robot-relevant state 품질과 downstream task success를 sensor noise와 partial observation 아래 개선하는가?

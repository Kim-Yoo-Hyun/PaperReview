...
- Abstract problem cue: While 3D Gaussian Splatting (3DGS) delivers high-quality, real-time rendering for bounded scenes, its extension to large-scale urban environments introduces critical challenges in geometric consistency, ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D reconstruction, 3D Vision` 관점의 개선을 제안한다.

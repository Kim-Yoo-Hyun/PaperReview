...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We compare the training time of our method with that of existing methods.
...
## 근거가 되는 논문 단서
- Method cue: We compare the training time of our method with that of existing methods.

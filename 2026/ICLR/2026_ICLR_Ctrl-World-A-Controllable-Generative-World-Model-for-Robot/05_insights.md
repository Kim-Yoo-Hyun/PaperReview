...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Third-view Camera WPE-Single-View WPE-Multiview IRASim-Single-View IRASim-Multiview Ctrl-World-Single-View Ctrl-World (ours) Computation-based PSNR ↑ SSIM ↑ Model-based LPIPS ↓ FID ↓ FVD ↓ 20.33 21.17 21.36 20.21 21.27 23.56 0.131 ...
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: 자동 추출에서 명확한 dataset 단서 없음 / PSNR, SSIM, LPIPS, success rate
...
## 근거가 되는 논문 단서
- Method cue: Third-view Camera WPE-Single-View WPE-Multiview IRASim-Single-View IRASim-Multiview Ctrl-World-Single-View Ctrl-World (ours) Computation-based PSNR ↑ SSIM ↑ Model-based LPIPS ↓ FID ↓ FVD ↓ 20.33 21.17 21.36 20.21 21.27 23.56 0.131 ...

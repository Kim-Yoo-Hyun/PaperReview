...
- **Method cue:** Open Drawer+2 Pick& Lift+0 Pick& Lift+2 Pick& Lift+7 PickUp Cup+8 PickUp Cup+9 PickUp Cup+11 Push Button+0 Push Button+3 Push Button+4 PutIn Cupboard+0 HiveFormer (Guhur et al., 2023) PolarNet ...
...
- **Registry interface:** `Robotics, 3D Vision, Imitation Learning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `Robotics, 3D Vision, Imitation Learning`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: 자동 추출에서 명확한 dataset 단서 없음 / mAP, ATE, success rate

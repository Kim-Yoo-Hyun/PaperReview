...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Baselines We compare our method with several representative baselines.
...
## 근거가 되는 논문 단서
- Method cue: Baselines We compare our method with several representative baselines.

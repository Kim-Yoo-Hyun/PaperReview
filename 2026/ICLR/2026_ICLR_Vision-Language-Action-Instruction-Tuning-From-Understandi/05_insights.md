...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We adopt a 1:7 multimodal-to-action training ratio, twice the ratio in ECoT and ChatVLA (1:3), reducing the additional computation needed to maintain multimodal ability.

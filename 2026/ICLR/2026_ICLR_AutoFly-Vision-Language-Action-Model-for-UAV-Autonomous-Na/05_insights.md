...
- **Method cue:** SR CR PER in Table 4 demonstrate that the method with the pseudo-depth w/ 47.9 21.9 77.3 encoder (47.9%, 21.9%) in success rate and collision rate sigw/o 44 ...
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: R2R, RxR, VLN-CE / mAP, SR, success rate, collision

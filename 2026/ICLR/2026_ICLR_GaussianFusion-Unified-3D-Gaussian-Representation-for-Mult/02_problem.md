...
- Abstract problem cue: However, the discrete grid representation of BEV leads to significant detail loss and limits feature alignment and cross-modal information interaction in multimodal fusion perception.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, sensor fusion, LiDAR, 3D Vision` 관점의 개선을 제안한다.

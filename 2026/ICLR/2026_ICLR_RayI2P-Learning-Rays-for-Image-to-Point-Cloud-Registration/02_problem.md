...
- Abstract problem cue: Existing methods fall into two categories: matching-free methods regress pose directly using geometric priors, but lack fine-grained supervision and struggle with precise alignment; matching-based ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `geometry, point cloud, 3D Vision` 관점의 개선을 제안한다.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: The final training objective combines both the standard training loss for action generation and the 3D foundation model alignment loss with a weighting factor α: LSF = Laction ...

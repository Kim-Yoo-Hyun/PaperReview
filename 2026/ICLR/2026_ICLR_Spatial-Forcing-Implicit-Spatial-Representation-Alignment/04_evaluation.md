...
## Dataset
Replica, CALVIN, LIBERO, BridgeData, Open X-Embodiment, OXE, Google Robot, WidowX, ManiSkill
...
## Main Results
- Abstract result cue: Vision-language-action (VLA) models have recently shown strong potential in enabling robots to follow language instructions and execute precise actions.

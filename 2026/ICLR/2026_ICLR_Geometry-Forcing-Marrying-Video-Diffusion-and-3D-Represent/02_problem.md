...
- Abstract problem cue: However, our analysis suggests that video diffusion models trained solely on raw video data often fail to capture meaningful geometric-aware structure in their learned ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Diffusion, Generation, 3D Vision` 관점의 개선을 제안한다.

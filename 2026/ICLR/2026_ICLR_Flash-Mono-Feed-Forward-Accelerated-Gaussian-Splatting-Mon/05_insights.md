...
- **Method cue:** This highlights the effectiveness of our Predict-and-Refine paradigm: high-quality Gaussians predicted by our foundation model reduce the need for costly backend optimization.
...
- **Registry interface:** `Gaussian Splatting, geometry, depth, 3D Vision` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Neural Scene Representations`; tags: `Gaussian Splatting, geometry, depth, 3D Vision`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ScanNet, KITTI / accuracy, AP, mAP, PSNR, SSIM

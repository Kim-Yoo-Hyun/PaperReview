...
- Abstract problem cue: Existing generation methods primarily focus on synthesizing diverse and high-fidelity driving videos; however, due to limited 3D consistency and sparse viewpoint coverage, they struggle ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, Diffusion, Generation, 3D Vision` 관점의 개선을 제안한다.

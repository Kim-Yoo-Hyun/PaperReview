...
- **Registry interface:** `Vision-Language Model, 3D Vision, Navigation, Gaussian Splatting` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Embodied Navigation and Mapping`; tags: `Vision-Language Model, 3D Vision, Navigation, Gaussian Splatting`.

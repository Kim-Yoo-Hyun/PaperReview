...
- Abstract problem cue: Feed-forward 3D reconstruction for autonomous driving has advanced rapidly, yet existing methods struggle with the joint challenges of sparse, non-overlapping camera views and complex ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, 3D reconstruction, sensor fusion, LiDAR` 관점의 개선을 제안한다.

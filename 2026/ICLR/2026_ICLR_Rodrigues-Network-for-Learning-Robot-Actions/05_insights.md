...
- **Claim/result cue:** We evaluate the expressivity of our network on two synthetic tasks on kinematic and motion prediction, showing significant improvements compared to standard backbones.
...
- **Registry interface:** `Robotics, kinematics, action representation, Imitation Learning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Robot Learning and Data`; tags: `Robotics, kinematics, action representation, Imitation Learning`.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: linguistic instruction and grounded physical execution.
- 출발 문제 단서: Prior work has approached this challenge through hierarchical robotic systems Huang et al. (2023; 2024a); Liu et al. (2024); Huang et al. (2024b); Qi et al. (2025); Cao ...
- 주장된 효과 단서: linguistic instruction and grounded physical execution.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: linguistic instruction and grounded physical execution.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: COCO, LIBERO / BLEU, IoU, mAP, SR, success rate
...
## 근거가 되는 논문 단서
- Problem cue: Prior work has approached this challenge through hierarchical robotic systems Huang et al. (2023; 2024a); Liu et al. (2024); Huang et al. (2024b); Qi et al. (2025); Cao ...
- Method cue: linguistic instruction and grounded physical execution.
- Result cue: linguistic instruction and grounded physical execution.

...
## 이 논문에서 가져갈 핵심 개념
- 주장된 효과 단서: Our MomaGraph-R1 achieves state-of-the-art performance among open-source VLMs, leading by 3.8% on BLINK and 4.8% on our correspondence benchmark compared to the best competing open-source models.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: Our MomaGraph-R1 achieves state-of-the-art performance among open-source VLMs, leading by 3.8% on BLINK and 4.8% on our correspondence benchmark compared to the best competing open-source models.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: AI2-THOR / accuracy, mAP
...
## 근거가 되는 논문 단서
- Result cue: Our MomaGraph-R1 achieves state-of-the-art performance among open-source VLMs, leading by 3.8% on BLINK and 4.8% on our correspondence benchmark compared to the best competing open-source models.

...
| Observation / input | In this work, we do not focus on the agent's interaction policy; instead, our emphasis lies on how to capture and incorporate ... | camera/depth stream, pose, map와 language goal | exact sensor/frame/preprocessing from PDF |
...
navigation writing domain maps to observation -> state/world model -> task and motion decision -> policy/control -> feedback. PDF interface anchors: p. 6 (4 METHOD), p. 5 (4 METHOD), p. 5 (4 METHOD), p. 3 (1 INTRODUCTION). The downstream handoff is claimed only when the body describes it.

## Verification Questions

- **PDF anchors reviewed:** problem p. 2 (1 INTRODUCTION), p. 3 (1 INTRODUCTION), p. 2 (1 INTRODUCTION), p. 3 (1 INTRODUCTION), p. 4 (1 INTRODUCTION), interface p. 6 (4 METHOD), p. 5 (4 METHOD), p. 5 (4 METHOD), p. 3 (1 INTRODUCTION), objective p. 5 (4 METHOD), p. 5 (4 METHOD), p. 6 (4 METHOD), p. 6 (4 METHOD).

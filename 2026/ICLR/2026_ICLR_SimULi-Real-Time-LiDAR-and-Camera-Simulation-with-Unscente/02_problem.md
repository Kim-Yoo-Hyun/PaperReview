...
| Observation / input | 3.4 OPTIMIZATION We jointly optimize the camera particles Gc, LiDAR particles Gl, bilateral grids A, and the environment map by sampling a ... | RGB-D, image set, point cloud, depth와 camera pose | exact sensor/frame/preprocessing from PDF body |
...
| Decision / output variable | geometry/map/query r; body terms: high-fidelity, efficient, reconstruction, pipeline, enables, joint, camera, LiDAR | p. 2 (1 INTRODUCTION), p. 3 (1 INTRODUCTION), p. 5 (3 METHOD) |
...
PDF body contribution framing (p. 2 (1 INTRODUCTION), p. 3 (1 INTRODUCTION), p. 5 (3 METHOD), p. 2 (1 INTRODUCTION), p. 4 (3 METHOD)): In this work, we propose a high-fidelity and efficient reconstruction pipeline that enables joint camera and LiDAR simulation for AV scenarios.
...
3d_perception writing domain maps to observation -> state/world model -> task and motion decision -> policy/control -> feedback. Evidence interface anchors: p. 6 (3 METHOD), p. 2 (1 INTRODUCTION), p. 6 (3 METHOD), p. 7 (3 METHOD). The downstream handoff is claimed only when the body describes it.

## Verification Questions

- **Evidence anchors reviewed:** problem p. 2 (1 INTRODUCTION), p. 2 (1 INTRODUCTION), p. 3 (1 INTRODUCTION), interface p. 6 (3 METHOD), p. 2 (1 INTRODUCTION), p. 6 (3 METHOD), p. 7 (3 METHOD), objective p. 7 (3 METHOD), p. 7 (3 METHOD), p. 5 (3 METHOD), p. 6 (3 METHOD), p. 6 (3 METHOD).

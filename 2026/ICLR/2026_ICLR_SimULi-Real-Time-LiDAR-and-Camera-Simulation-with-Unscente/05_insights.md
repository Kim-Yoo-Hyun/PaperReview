...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We minimize the K-distance loss at each training iteration, and update the camera-to-LiDAR assignments every 1000 iterations.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: Waymo / accuracy, mAP, Chamfer, PSNR, SSIM
...
## 근거가 되는 논문 단서
- Method cue: We minimize the K-distance loss at each training iteration, and update the camera-to-LiDAR assignments every 1000 iterations.

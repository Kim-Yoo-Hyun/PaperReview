...
- **Method cue:** Observation Method RxR Val-Unseen Training Pano.
...
- **Registry interface:** `Vision-Language Model, 3D Vision, Navigation, semantic` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Embodied Navigation and Mapping`; tags: `Vision-Language Model, 3D Vision, Navigation, semantic`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: Matterport3D, Habitat, R2R, RxR, VLN-CE / mAP, SPL, SR, nDTW, success rate

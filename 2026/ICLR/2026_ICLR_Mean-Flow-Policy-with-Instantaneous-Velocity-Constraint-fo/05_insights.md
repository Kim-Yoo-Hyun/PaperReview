...
- **Registry interface:** `Robotics, flow policy, one-step generation, manipulation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Robot Learning and Data`; tags: `Robotics, flow policy, one-step generation, manipulation`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ImageNet / accuracy, mAP, success rate

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: This indicates that although 3DGS scene data offers faster rendering, it presents greater training difficulty and is relatively harder to converge.

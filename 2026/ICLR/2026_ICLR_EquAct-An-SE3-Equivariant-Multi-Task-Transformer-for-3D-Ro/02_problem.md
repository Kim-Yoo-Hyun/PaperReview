...
- Abstract problem cue: However, real-world tasks frequently require robots to generalize to novel 3D object poses.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, 3D Vision, equivariant` 관점의 개선을 제안한다.

...
- **Method cue:** 5.1, indicating that EG, which groups by FGW-based distance, better aligns updates during training.
...
- **Registry interface:** `Robotics, offline reinforcement learning, cross-embodiment, transfer` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Robot Learning and Data`; tags: `Robotics, offline reinforcement learning, cross-embodiment, transfer`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: Open X-Embodiment / mAP

...
- **Method cue:** Count: 9 Count: 9 Success Rate : 3 / 5 Success Rate : 1 / 5 (a) Object Counting Task on ScanRefer (Scene0011_00) Our method Vanilla Gemini 2.5 ...
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ScanNet, Waymo, ETH3D, ScanRefer, ScanQA / accuracy, mIoU, IoU, AP, mAP

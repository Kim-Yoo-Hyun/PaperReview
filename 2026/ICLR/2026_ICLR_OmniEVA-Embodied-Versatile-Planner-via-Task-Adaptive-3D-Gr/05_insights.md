...
- **Claim/result cue:** These two reward components reflect distinct optimization objectives: ritask emphasizes performance on offline evaluation benchmarks, while riembod targets end-to-end execution success in real-world robotic deployments.

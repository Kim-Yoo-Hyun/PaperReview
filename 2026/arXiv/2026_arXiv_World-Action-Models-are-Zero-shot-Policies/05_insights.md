...
- **Claim/result cue:** This results in over 2× improvement in generalization to new tasks and environments compared to state-of-the-art VLAs in realrobot experiments.
...
- **Registry interface:** `Robotics, VLA, world model, zero-shot policy, action representation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `World Models, Safety, and Recovery`; tags: `Robotics, VLA, world model, zero-shot policy, action representation`.

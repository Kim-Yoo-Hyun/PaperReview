...
- **p. 6 / IV. EXPERIMENTS - extractive body cue:** Experiments on these two datasets illustrate the capability of our system in handling complex real-world scenes, boosting the practicality of object-level camera relocalization.
- **p. 5 / IV. EXPERIMENTS - extractive body cue:** In the single-room case, we utilize two real-world RGB-D indoor datasets: ScanNet [9] and ScanNet++ [10].
- **p. 7 / IV. EXPERIMENTS - extractive body cue:** This table shows average metrics over multi-room/floor scenes of the Synthetic dataset.
...
- **p. 6 / IV. EXPERIMENTS - extractive body cue:** These ScanNet and ScanNet++ scenes are captured from the real world, where rich object diversity falls beyond the closed-vocabulary scope of GoReloc.
- **p. 7 / IV. EXPERIMENTS - extractive body cue:** Scenes used in our experiments all exhibit a long-tail object distribution.
- **p. 7 / IV. EXPERIMENTS - extractive body cue:** As such, it does not demand strict realtime performance but places greater emphasis on success rate and accuracy.
- **p. 7 / IV. EXPERIMENTS - extractive body cue:** Unlike GoReloc, which excessively prioritizes high efficiency at the cost of system performance, ours and PixLoc strike a more balanced trade-off among success rate, accuracy, ...
...
- **p. 3 / Figure/Table caption - extractive body cue:** Fig. 2: System Overview. Our system includes three main steps: (1) Object-oriented Mapping. We construct an object-level map from an RGB-D sequence and its 2D ...
- **p. 4 / Figure/Table caption - extractive body cue:** Fig. 3: Subgraph Similarity. We seek an assignment among all possible neighbor pairs to maximize the total matching score as the subgraph similarity. negatively impacting ...
- **p. 5 / Figure/Table caption - extractive body cue:** Fig. 4: DIOU Metric. (Left) DIOU calculation. (Right) A case illustrates the intention behind the DIOU metric. where bq and br represent 2D bounding box ...
- **p. 6 / Figure/Table caption - extractive body cue:** Fig. 5: Qualitative visualization. We qualitatively show relocalization poses and their ground truth on various scenes. TABLE III: Recall and Accuracy on Synthetic. Each cell ...
...
- **p. 7 / Figure/Table caption - extractive body cue:** Fig. 7: Lighting Variation. We display the scene appearance under progressive illumination decay. Et: 0.06m Er: 1.44° Et: 0.18m Er: 4.76° Et: 0.21m Er: 4.41° ...
- **p. 7 / Figure/Table caption - extractive body cue:** Fig. 8: Object Displacement. We displaced several objects in synthetic scenes and evaluated quantitative metrics. F. Robustness Analysis Object-level approaches are inherently robust to environ- ...
...
- **p. 5 / IV. EXPERIMENTS - extractive body cue:** We run our system on a desktop equipped with an NVIDIA RTX 4090 GPU.
- **p. 7 / IV. EXPERIMENTS - extractive body cue:** Metric PixLoc Ours Object Detection GPT Analysis CLIP Encoding Coarse-to-fine Pose Total Runtime ≈4.5s ≈0.3s ≈4.1s ≈0.2s ≈0.5s ≈5.1s " Gray Toy Dolphin" " Red ...

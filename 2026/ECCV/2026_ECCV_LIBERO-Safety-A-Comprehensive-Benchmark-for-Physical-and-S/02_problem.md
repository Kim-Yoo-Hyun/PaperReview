...
- Abstract problem cue: Despite the impressive manipulation capabilities of Vision-Language-Action (VLA) models, their operational safety under strict constraints remains largely unverified.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, Vision-Language Model, Benchmark, semantic` 관점의 개선을 제안한다.

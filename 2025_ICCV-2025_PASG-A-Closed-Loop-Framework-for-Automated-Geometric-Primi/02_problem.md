...
- Abstract problem cue: The fragmentation between high-level task semantics and low-level geometric features remains a persistent challenge in robotic manipulation.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, semantic` 관점의 개선을 제안한다.

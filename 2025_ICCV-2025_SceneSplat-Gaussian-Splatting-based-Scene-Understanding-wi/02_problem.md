...
- Abstract problem cue: However, effectively integrating semantic reasoning into 3DGS in a generalizable fashion remains an open challenge.To address these limitations we introduce SceneSplat, to our knowledge ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, Vision-Language, semantic` 관점의 개선을 제안한다.

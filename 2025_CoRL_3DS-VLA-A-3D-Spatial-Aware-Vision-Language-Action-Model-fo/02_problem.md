...
- Abstract problem cue: However, these models struggle to reason about 3D spatial relationships from 2D image inputs.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, 3D Vision, Robotics` 관점의 개선을 제안한다.

...
- Abstract problem cue: Robotic manipulation in complex 3D environments requires unifying spatial reasoning with intuitive visual perception, which is a capability that current Vision-Language-Action paradigms address separately.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, 3D-2D alignment, Robotics` 관점의 개선을 제안한다.

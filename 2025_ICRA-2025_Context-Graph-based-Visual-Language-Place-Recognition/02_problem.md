...
- Abstract problem cue: However, these approaches still fail under drastic changes and require large amounts of labeled data to train models, presenting a significant limitation.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Graph Reasoning` 관점의 개선을 제안한다.

...
| `SYNTHESIZED` | 같은 트랙의 논문과 비교까지 완료함 | synthesis comparison matrix와 `Open Questions` 갱신 |
...
3. 해당 [synthesis](../synthesis/README.md) 문서의 comparison matrix와 `Open Questions` evidence를 갱신한다.

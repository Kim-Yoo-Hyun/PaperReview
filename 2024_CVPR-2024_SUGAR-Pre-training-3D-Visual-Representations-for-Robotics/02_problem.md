...
- Abstract problem cue: Meanwhile 3D representation learning has been limited to single-object understanding.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D representation, Robotics, pretraining` 관점의 개선을 제안한다.

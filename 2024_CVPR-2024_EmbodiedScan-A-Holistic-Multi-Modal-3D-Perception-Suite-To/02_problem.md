...
- Abstract problem cue: However traditional research focuses more on scene-level input and output setups from a global view.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Vision, Embodied AI, dataset` 관점의 개선을 제안한다.

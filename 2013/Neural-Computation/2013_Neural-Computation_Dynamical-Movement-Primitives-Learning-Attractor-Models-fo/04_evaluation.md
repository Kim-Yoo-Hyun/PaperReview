...
- **p. 22 / 3 Evaluations - extractive PDF cue:** In the next sections, we present and review several experimental evaluations of applying our approach to learning attractor systems in the domain of motor control, ...
- **p. 22 / 3 Evaluations - extractive PDF cue:** In robotics, one of the most common classic methods to represent movement plans is by means of third-order or fifth-order splines, which could be equally ...
- **p. 24 / 3 Evaluations - extractive PDF cue:** A state-space mixture model for our humanoid robot above would require a 60-dimension state space and thus would create computational and numerical problems.
- **p. 26 / 3 Evaluations - extractive PDF cue:** In the second row, the (green) target is suddenly moved to the right while the robot has already begun moving.
- **p. 26 / 3 Evaluations - extractive PDF cue:** The third row of images demonstrates an avoidance behavior based on equation 3.2, when the blue ball comes too close to the robot's movement.
- **p. 27 / 3 Evaluations - extractive PDF cue:** Dynamical Movement Primitives 353 Obstacle Avoidance Movement Online Adaptation to changing target Orignal Figure 9: Sarcos slave robot placing a red cup on a green ...
- **p. 29 / 3 Evaluations - extractive PDF cue:** In the beginning, the robots started from immobility (ω = 0).
- **p. 29 / 3 Evaluations - extractive PDF cue:** Dynamical Movement Primitives 355 to which the slow drumbeat of the robot was to synchronize.
...
- **p. 8 / Figure/Table caption - extractive PDF cue:** Figure 1: Exemplary time evolution of the discrete dynamical system. The pa- rameters wi have been adjusted to fit a fifth-order polynomial trajectory between start ...
- **p. 9 / Figure/Table caption - extractive PDF cue:** Figure 2: Vector plot for a 2D trajectory where y1 (top left) fits the trajectory of Figure 1 and y2 (bottom left) fits a minimum ...
- **p. 11 / Figure/Table caption - extractive PDF cue:** Figure 3: Exemplary time evolution of the rhythmic dynamical system (limit cycle behavior). The parameters wi have been adjusted to fit a trajectory ydemo(t) = ...
- **p. 13 / Figure/Table caption - extractive PDF cue:** Figure 4: Illustration of invariance properties in the discrete dynamical systems, using the example from Figure 1. (a) The goal position is varied from -1 ...
- **p. 14 / Figure/Table caption - extractive PDF cue:** Figure 5: Illustration of the significance of the invariance properties, exempli- fied in a two-dimensional discrete dynamical system to draw a cursive letter a. In ...
- **p. 16 / Figure/Table caption - extractive PDF cue:** Figure 6: Conceptual illustration of a multi-DOF dynamical system. The canon- ical system is shared, while each DOF has its own nonlinear function and trans- ...
- **p. 19 / Figure/Table caption - extractive PDF cue:** Figure 7: Graphical sketch of the design principle of our approach to learnable dynamical systems. movement, it is easily possible to choose a second-order system ...
- **p. 23 / Figure/Table caption - extractive PDF cue:** Table 1: Summary of the Equations for Our Discrete and Rhythmic Model Equations. Discrete Rhythmic Transformation system: Transformation system: τ ˙z = αz(βz(g -y) -z) ...
...
- **p. 22 / 3 Evaluations - extractive PDF cue:** (2003) and Ijspeert, Nakanishi, and Schaal (2002a) demonsrated imitation learning with a 30 degrees-of-freedom (DOFs) humanoid robot (Atkeson et al., 2000) for performing a tennis ...
- **p. 25 / 3 Evaluations - extractive PDF cue:** We start with a 3 degree-of-freedom (DOF) discrete movement system that models point-to-point reaching in a 3D Cartesian space.
- **p. 25 / 3 Evaluations - extractive PDF cue:** The vector r is the vector that is perpendicular to the plane spanned by ˙y and (o -y), and serves to define a rotation matrix ...
- **p. 29 / 3 Evaluations - extractive PDF cue:** Within two beats (the time needed to extract the frequency from the acoustic signal), perfect synchronization and phase locking is achieved with a 0.15 Hz ...
- **p. 29 / 3 Evaluations - extractive PDF cue:** Afterward, we had the external metronome pace increase frequency slowly to 0.5 Hz to demonstrate the continuous adaptation ability of the oscillator.
- **p. 29 / 3 Evaluations - extractive PDF cue:** At time t = 0.35 s, the point mass is suddenly blocked from any further motion and released again at t = 0.9 s.
...
- **p. 26 / Figure/Table caption - extractive PDF cue:** Figure 8: Illustration of obstacle avoidance with a coupling term. The obstacle is the large (red) sphere in the center of the plot. Various trajectories ...
- **p. 29 / 3 Evaluations - extractive PDF cue:** In this section, we illustrate how both temporal and spatial coupling can be used together to model disturbance rejection, a property that is inherent in ...
- **p. 31 / 3 Evaluations - extractive PDF cue:** Thus, for instance, a variation at the end of a movement will not affect the parameter values at the beginning of a movement, which creates ...

- **PDF anchors reviewed:** datasets p. 22 (3 Evaluations), p. 22 (3 Evaluations), p. 24 (3 Evaluations), p. 26 (3 Evaluations), p. 26 (3 Evaluations), p. 27 (3 Evaluations), metrics p. 22 (3 Evaluations), p. 29 (3 Evaluations), p. 29 (3 Evaluations), p. 30 (3 Evaluations), p. 30 (3 Evaluations), p. 33 (Figure/Table caption), baselines p. 23 (3 Evaluations), p. 33 (Figure/Table caption), p. 9 (Figure/Table caption), p. 24 (3 Evaluations), p. 26 (3 Evaluations), p. 29 (3 Evaluations), results p. 29 (3 Evaluations), p. 30 (3 Evaluations), p. 22 (3 Evaluations), p. 9 (Figure/Table caption), p. 33 (Figure/Table caption).

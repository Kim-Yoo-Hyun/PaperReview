...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: To this end, we propose to inject the 3D world into large language models, and introduce a whole new family of 3D-LLMs that could take 3D representations (i.e., ...
- 출발 문제 단서: One major challenge of training the proposed 3D-LLMs lies in data acquisition.
- 주장된 효과 단서: Experiments on ScanQA show that our model outperforms state-of-the-art baselines by a large margin (e.g., the BLEU-1 score surpasses state-of-the-art score by 9%).
...
- Result cue: Experiments on ScanQA show that our model outperforms state-of-the-art baselines by a large margin (e.g., the BLEU-1 score surpasses state-of-the-art score by 9%).

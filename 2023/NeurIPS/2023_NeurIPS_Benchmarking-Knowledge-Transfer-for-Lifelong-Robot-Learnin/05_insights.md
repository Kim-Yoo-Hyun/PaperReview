...
- **Registry interface:** `Robotics, Imitation Learning, Benchmark` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Benchmarks and Datasets`; tags: `Robotics, Imitation Learning, Benchmark`.

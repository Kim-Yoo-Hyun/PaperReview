# Insights — PaLM-E: An Embodied Multimodal Language Model
...
- Result/evaluation cue: Further, in our experiments we show that current state-of-the-art visuallanguage models trained on typic

위 cue는 기존 official abstract 또는 local text extraction에서 보존한 것이다. 수치·조건·인과적 해석은 full-text 정독 전까지 `UNVERIFIED`다.

## Dependency Position

`CLIPort: What and Where Pathways for Robotic Manipulation → PaLM-E: An Embodied Multimodal Language Model → RT-1: Robotics Transformer for Real-World Control at Scale`

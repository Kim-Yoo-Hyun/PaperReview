...
- Abstract problem cue: However, achieving high visual quality still requires neural networks that are costly to train and render, while recent faster methods inevitably trade off speed ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, 3D reconstruction, representation` 관점의 개선을 제안한다.

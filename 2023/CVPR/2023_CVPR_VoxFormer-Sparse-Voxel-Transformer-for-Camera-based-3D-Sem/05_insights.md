...
- **Claim/result cue:** Experiments on SemanticKITTI show that VoxFormer outperforms the state of the art with a relative improvement of 20.0% in geometry and 18.1% in semantics and reduces GPU memory ...
...
- Registry position: `Autonomous 3D Perception and Sensor Fusion`; tags: `semantic, alignment, 3D Vision`.

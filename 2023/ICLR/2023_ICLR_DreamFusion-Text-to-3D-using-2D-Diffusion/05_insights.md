...
- **Method cue:** R-Precision ↑ CLIP B/32 CLIP B/16 CLIP L/14 Color Geo Color Geo Color Geo GT Images 77.1 – 79.1 – – Dream Fields (reimpl.) CLIPMesh – Dream Fields ...
...
- **Registry interface:** `3D Vision, Diffusion, Generation, text-to-3D` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Generative Modeling`; tags: `3D Vision, Diffusion, Generation, text-to-3D`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: COCO / accuracy, mAP, Chamfer, PSNR

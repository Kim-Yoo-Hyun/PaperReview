...
- **p. 4 / IV. APPROACH - extractive body cue:** While training the contrastive loss objective, we also take into consideration the associated label weights.
- **p. 5 / IV. APPROACH - extractive body cue:** Similar to the previous objective, given CLIP visual embedding Cs associated with the points, the mapping h = headv◦g, the distance between camera and the ...
...
- **p. 5 / IV. APPROACH - extractive body cue:** Similar to the previous objective, given CLIP visual embedding Cs associated with the points, the mapping h = headv◦g, the distance between camera and the ...
- **p. 5 / IV. APPROACH - extractive body cue:** semantic label, f = heads ◦g is the associated semantic encoding function, F is a pre-trained semantic language encoder, c is the confidence associated with ...
- **p. 3 / IV. APPROACH - extractive body cue:** Segment a scene image by doing so for each pixel. • Object navigation: For a given semantic query qs (or a visual query qv) find ...
- **p. 4 / IV. APPROACH - extractive body cue:** CLIP-Fields are trained on a specific scene with a contrastive loss, similar to CLIP [22].
- **p. 3 / IV. APPROACH - extractive body cue:** Use the alignment between a label embedding and f(Pi) to find the label with the highest probability for that pixel.
...
- **p. 3 / IV. APPROACH - extractive body cue:** For ease of decoding, we constrain the output spaces of f, h to match the embedding space of pre-trained language and vision-language models, respectively.
- **p. 4 / IV. APPROACH - extractive body cue:** The objective-specific heads are simple two-layer MLPs with ReLU nonlinearities that map the 144 dimensional outputs of g into higher dimensions which depend on the ...
- **p. 4 / IV. APPROACH - extractive body cue:** These include heads that outputs a vector that matches a natural language description of what is at the point in space, and headv that matches ...
- **p. 1 / I. INTRODUCTION - extractive body cue:** Their applications have been limited, however, by the fact that these trained representations assume a single 2D image as input; it is an open question ...
- **p. 3 / IV. APPROACH - extractive body cue:** Problem Statement We aim to build a system that can connect points of a 3D scene with their visual and semantic meaning.
- **p. 2 / III. BACKGROUND - extractive body cue:** In this section, we provide descriptions of the recent advances in machine learning that makes CLIP-Fields possible. a) Contrastive Image-Language Pretraining: This pretraining method, colloquially ...
...
- **p. 6 / V. EXPERIMENTAL EVALUATION - extractive body cue:** On this setting, we train CLIP-Fields with the provided instance segmented RGB-D images and the associated odometry data, and compare with the baseline pretrained 2D ...
...
- **p. 7 / V. EXPERIMENTAL EVALUATION - extractive body cue:** Semantic Navigation on Robot with CLIP-Fields as Semantic-Spatial Memory Training a CLIP-Fields with available data, whether they are labeled by humans or pretrained models, gives ...
...
- **Evidence anchors reviewed:** method p. 4 (IV. APPROACH), p. 5 (IV. APPROACH), p. 4 (IV. APPROACH), p. 5 (IV. APPROACH), p. 3 (IV. APPROACH), p. 3 (IV. APPROACH), objective p. 4 (IV. APPROACH), p. 5 (IV. APPROACH), p. 5 (IV. APPROACH), p. 3 (IV. APPROACH), p. 4 (IV. APPROACH), p. 3 (IV. APPROACH), temporal p. 2 (II. RELATED WORK), p. 5 (V. EXPERIMENTAL EVALUATION), p. 5 (V. EXPERIMENTAL EVALUATION), p. 6 (V. EXPERIMENTAL EVALUATION), p. 7 (V. EXPERIMENTAL EVALUATION), p. 7 (V. EXPERIMENTAL EVALUATION).

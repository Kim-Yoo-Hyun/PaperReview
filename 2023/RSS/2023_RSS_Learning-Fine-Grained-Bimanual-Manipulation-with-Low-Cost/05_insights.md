...
- **Registry interface:** `Robotics, bimanual manipulation, Imitation Learning, action chunking` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Robotics Foundations: Robot Learning`; tags: `Robotics, bimanual manipulation, Imitation Learning, action chunking`.

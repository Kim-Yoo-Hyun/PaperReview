...
- Abstract problem cue: Recently introduced Gaussian Splats efficiently model object geometry, but lack persistent state estimation for task-oriented manipulation.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Gaussian Splatting, Reinforcement Learning` 관점의 개선을 제안한다.

...
- **p. 4 / 3.3. LLM-assisted 3D-language Data Generation - extractive body cue:** Next, we manually design some examples as seed tasks (Liu et al., 2023b), including scene and object captioning, QA, dialogue, and planning, and ask LLM ...
- **p. 4 / 3. Datasets - extractive body cue:** The statistics and examples of these datasets can be found in Tab.
- **p. 5 / 3.3. LLM-assisted 3D-language Data Generation - extractive body cue:** An Embodied Generalist Agent in 3D World Dialogue(O-CoT): Dialogue Context: high level task: organize the bedroom. low level task: check some objects.
- **p. 5 / 3.3. LLM-assisted 3D-language Data Generation - extractive body cue:** Thought:wardrobe2, desk-7, chair-11, bed-15 Answer: bedroom Object Scene Caption: The showcase is supported by the wall and positioned behind, close to, and to the left ...
- **p. 8 / 4.5. Scaling Law Analysis - extractive body cue:** We study the scaling effect (Kaplan et al., 2020; Reed et al., 2022) of data and model in LEO by tracking the instruction-tuning loss on ...
- **p. 6 / Figure/Table caption - extractive body cue:** Table 4: Quantitative comparison with state-of-the-art models on 3D VL under- standing and embodied reasoning tasks. "C" stands for "CIDEr", "B-4" for "BLEU- 4", "M" ...
- **p. 4 / Figure/Table caption - extractive body cue:** Table 2: Answer accuracy of LLM-generated data on three types of questions. Counting Existence Non-existence 3D-LLM 56.5 96.8 40.0 Ours
...
- **p. 4 / Figure/Table caption - extractive body cue:** Table 1: Datasets statistics. We illustrate key statistics of datasets for 3D VL alignment (LEO-align) and 3D VLA instruction tuning (LEO-instruct). res. (response) denotes tokens ...
- **p. 4 / Figure/Table caption - extractive body cue:** Table 2: Answer accuracy of LLM-generated data on three types of questions. Counting Existence Non-existence 3D-LLM 56.5 96.8 40.0 Ours
- **p. 4 / Figure/Table caption - extractive body cue:** Table 3: The amount of examined data in
- **p. 4 / Figure/Table caption - extractive body cue:** Tab. 2. 3D-LLM data (Hong et al., 2023) is much less since we can only access a subset. Counting Existence Non-existence 3D-LLM 434 95 10 ...
...
- **p. 6 / Figure/Table caption - extractive body cue:** Table 4: Quantitative comparison with state-of-the-art models on 3D VL under- standing and embodied reasoning tasks. "C" stands for "CIDEr", "B-4" for "BLEU- 4", "M" ...
- **p. 6 / Figure/Table caption - extractive body cue:** Table 5: Results on robot manipulation. seen indicates in-domain tasks. unseen marks OOD tasks with novel colors or objects. separating-piles packing-google -objects-seq put-blocks-in -bowls seen
...
- **p. 7 / 4.3. Embodied Action in 3D World - extractive body cue:** Answerable Unanswerable NLP w/o Dialg 24.4±1.3 23.1±1.4 23.4±1.4 w/ Dialg 25.6±1.3 26.8±1.4 26.6±1.4 Table 9: Answer accuracy (EM) on objectexistence questions.

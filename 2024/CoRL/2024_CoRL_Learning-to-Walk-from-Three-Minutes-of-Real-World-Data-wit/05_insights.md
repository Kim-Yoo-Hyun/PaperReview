...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We introduce a novel framework for learning semi-structured dynamics models for contact-rich systems which seamlessly integrates structured first principles modeling techniques with black-box auto-regressive models.
- 출발 문제 단서: Indeed, modeling contact remains an open problem.
- 주장된 효과 단서: Video and code are available at: https://sites.google.com/utexas.edu/ssrl 4.1 Real-world Results We demonstrate our approach through two real-world experiments where a Unitree Go1 quadruped is trained from scratch to ...
...
- Result cue: Video and code are available at: https://sites.google.com/utexas.edu/ssrl 4.1 Real-world Results We demonstrate our approach through two real-world experiments where a Unitree Go1 quadruped is trained from scratch to ...

...
> Analysis basis: full-text PDF body checked on 2026-09-02 (30 pages; PyMuPDF text; title-token overlap first two pages=1.0); canonical paper source: https://proceedings.mlr.press/v270/huang25g.html.
> PDF retrieval source: https://raw.githubusercontent.com/mlresearch/v270/main/assets/huang25g/huang25g.pdf. Reading tracker status/evidence was not changed.
...
- Paper type: method
- Source audit: full-text PDF body checked on 2026-09-02 (30 pages; PyMuPDF text; title-token overlap first two pages=1.0)

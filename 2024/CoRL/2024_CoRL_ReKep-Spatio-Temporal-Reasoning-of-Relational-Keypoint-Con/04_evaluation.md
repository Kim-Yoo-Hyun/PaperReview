...
- We purposefully select a set of tasks (shown in Fig.
...
## Baselines
- We compare to VoxPoser as a baseline.
- Compared to baselines, ReKep can effectively handle core challenges of each task.

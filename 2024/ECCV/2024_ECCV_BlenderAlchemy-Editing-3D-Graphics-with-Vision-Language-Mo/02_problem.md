...
- Abstract problem cue: Moreover, slightly different design goals may require completely different sequences, making automation difficult.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model, 3D Vision, Graph Reasoning` 관점의 개선을 제안한다.

...
- We also evaluate our gravity estimation as a prior for visual localization.
...
## Baselines
- 5.1 Gravity and Field-of-View estimation We first compare GeoCalib to existing deep and classical approaches with pinhole images from four real-world datasets.

...
- Abstract problem cue: Based on pointmaps regression, this method displayed impressive robustness in matching views with extreme viewpoint changes, yet with limited accuracy.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D geometry, matching, calibration` 관점의 개선을 제안한다.

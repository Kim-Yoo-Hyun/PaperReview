...
## 선행 연구 / 배경 단서
- In this way, the detection model fails to detect objects not belonging to the training object classes.
- The traditional training pipeline for the detection model relies on elaborately labeled data, resulting in a limited number of classes that can be collected and annotated.
- As a basic function of machine perception, object detection has attracted much attention within computer vision communities.

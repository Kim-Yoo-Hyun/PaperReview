...
| Observation / input | We then detail the input data pre-processing steps and further describe the proposed Gaussian Grouping in Section 3.2. | RGB-D, image set, point cloud, depth와 camera pose | exact sensor/frame/preprocessing from PDF body |
...
3d_perception writing domain maps to observation -> state/world model -> task and motion decision -> policy/control -> feedback. Evidence interface anchors: p. 5 (3 Method), p. 5 (3 Method), p. 2 (1 Introduction), p. 6 (3 Method). The downstream handoff is claimed only when the body describes it.

## Verification Questions

- **Evidence anchors reviewed:** problem p. 4 (1 Introduction), p. 2 (1 Introduction), p. 2 (1 Introduction), p. 4 (1 Introduction), interface p. 5 (3 Method), p. 5 (3 Method), p. 2 (1 Introduction), p. 6 (3 Method), objective p. 6 (3 Method), p. 6 (3 Method), p. 7 (3 Method), p. 7 (3 Method), p. 8 (3 Method), p. 8 (3 Method).

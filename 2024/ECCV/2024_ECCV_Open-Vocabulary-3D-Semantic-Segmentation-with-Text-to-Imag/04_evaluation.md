...
## Dataset
ScanNet, ScanNet200, Nr3D, ReferIt3D, Replica, Matterport3D, OXE, LAION
...
## Main Results
- Abstract result cue: We show that it outperforms competitive baselines and achieves significant improvements over state-of-the-art methods.

...
- 4.1 Proposed Dataset To demonstrate the generality of the stated problem setting and test the efficiency of the proposed method, we collect 3D meshes from BlendedMVS and construct ...
- Furthermore, we perform a series of ablation studies and analyses to verify the effectiveness of each proposed component (Sec.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We present EchoScene, an interactive and controllable generative model that generates 3D indoor scenes on scene graphs.
- 출발 문제 단서: Existing methods struggle to handle scene graphs due to varying numbers of nodes, multiple edge combinations, and manipulatorinduced node-edge operations.
- 주장된 효과 단서: This is achieved through an information echo scheme in both shape and layout branches.
...
- Result cue: This is achieved through an information echo scheme in both shape and layout branches.

...
## 선행 연구 / 배경 단서
- Novel view synthesis (NVS) aims to produce realistic images at novel viewpoints from a set of source images.
- By encoding scenes into implicit radiance fields, NeRF has achieved remarkable success.

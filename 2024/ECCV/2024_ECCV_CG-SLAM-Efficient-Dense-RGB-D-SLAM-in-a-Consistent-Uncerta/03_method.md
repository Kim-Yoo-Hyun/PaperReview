...
- **p. 5 / 3 Method - extractive body cue:** 3.1 Preliminary Scene Representation.
- **p. 6 / 3 Method - extractive body cue:** (9) 3.2 Uncertainty Modeling Uncertainty model remains a trending topic in multi-view 3D reconstruction in recent decades.
- **p. 8 / 3 Method - extractive body cue:** 3.3 Mapping We employ various loss functions to update Gaussian properties, aiming for a consistent and stable Gaussian field.
...
- **p. 7 / 3 Method - extractive body cue:** To mitigate drastic changes in positions of Gaussian primitives during optimization, we proposed a geometry variance loss term (Eq.
- **p. 8 / 3 Method - extractive body cue:** 3.3 Mapping We employ various loss functions to update Gaussian properties, aiming for a consistent and stable Gaussian field.
- **p. 8 / 3 Method - extractive body cue:** To overcome anisotropic interference (Arrow-shaped Gaussian primitives), we add a soft scale regularization loss in the mapping process.
- **p. 5 / 3 Method - extractive body cue:** 3.3, we detail the Gaussian primitive management strategy and some innovative loss terms that ensure geometry stability and accuracy.
- **p. 6 / 3 Method - extractive body cue:** In terms of depth rendering, considering the loss term designed for geometry consistency, our rasterizer provides not only α-blending depth ˆDalpha but also the median ...
...
- **p. 7 / 3 Method - extractive body cue:** Hence, we propose an uncertainty model suitable for RGB-D observations from two perspectives: rendering images and Gaussian primitives.
- **p. 7 / 3 Method - extractive body cue:** \ l abe l {eq -1 0 } U = \sum _{i=1}^N \alpha _i T_i (~d_i - D~)^2~, (10) where D represents depth observations from ...
- **p. 8 / 3 Method - extractive body cue:** 8 Jiarui Hu and Xianhao Chen et al. is determined by the difference between its depth and depth observations from all its dominated pixels within ...
- **p. 8 / 3 Method - extractive body cue:** Dk p represents the depth observation on a pixel p in fk. dk i is the depth value of the i-th Gaussian primitive at fk. ...
- **p. 9 / 3 Method - extractive body cue:** In initialization, we densely project Gaussian primitives into 3D space based on depth observations of the first frame.
...
- **p. 13 / 56.50 MB - extractive body cue:** 4.4 Ablation Study To verify the rationality of our designs, we investigate the effectiveness of the anisotropy regularization, alignment and variance losses, and uncertainty model.
- **p. 14 / Figure/Table caption - extractive body cue:** Table 6: Isotropy Loss Ablation Results(ATE RMSE [cm] ↓). The experimental results demonstrate the effectiveness of our anisotropy regularization term. "-" indicates a failure situation. ...
- **p. 13 / 56.50 MB - extractive body cue:** To more intuitively illustrate this phenomenon, we display opacity maps with and without anisotropy regularization in Fig.
- **p. 14 / 56.50 MB - extractive body cue:** For further quantitative ablation results, refer to the supplementary material.
...
- **Evidence anchors reviewed:** method p. 7 (3 Method), p. 7 (3 Method), p. 9 (3 Method), p. 9 (3 Method), p. 5 (3 Method), p. 5 (3 Method), objective p. 5 (3 Method), p. 7 (3 Method), p. 8 (3 Method), p. 8 (3 Method), p. 5 (3 Method), p. 6 (3 Method), temporal p. 9 (3 Method), p. 2 (1 Introduction), p. 5 (3 Method), p. 5 (3 Method), p. 6 (3 Method), p. 6 (3 Method).

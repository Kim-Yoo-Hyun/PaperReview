...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: To the best of our knowledge, our method is the first approach leveraging largescale multisensory pre-training for robotic manipulation.
- 출발 문제 단서: This gap arises due to the lack of relevant data at a comparable scale for tactile sensing.
- 주장된 효과 단서: INTRODUCTION Two key components consistently improve the performance of robotic manipulation: (1) pre-training on a large amount of data – and (2) using multisensory input, especially tactile sensing ...
...
- Result cue: INTRODUCTION Two key components consistently improve the performance of robotic manipulation: (1) pre-training on a large amount of data – and (2) using multisensory input, especially tactile sensing ...

...
- **p. 2 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** We consider a purely zero-shot attention-based control mechanism, where the action ai of the agent corresponding to the particular target ti (i = 1, ..., ...
- **p. 3 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** Learnable preprocessing corresponds here to fine-tuning matrices WQ and WK ([3]) from Transformers' attention modules, but in the linear attention context.
- **p. 3 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** We thus propose the process of the self-adaptation of their attention modules, that we refer to as up-training, which can be implemented as replacing regular ...
...
- **p. 4 / III. THE MATHEMATICS OF SARA-RTS - extractive PDF cue:** Then there exist v ∈Rm, G1, G2 ∈Rm×d, f : R → R such that the approximate attention matrix bA (implicitly) given by the mappings ...
- **p. 4 / III. THE MATHEMATICS OF SARA-RTS - extractive PDF cue:** Denote by pϵ the probability of an event E(ϵ) = {∃i,j/bK(qi, kj) -K(qi, kj)/ > ϵK(qi, kj)}.
...
- **p. 4 / III. THE MATHEMATICS OF SARA-RTS - extractive PDF cue:** Denote by pϵ the probability of an event E(ϵ) = {∃i,j/bK(qi, kj) -K(qi, kj)/ > ϵK(qi, kj)}.
- **p. 4 / III. THE MATHEMATICS OF SARA-RTS - extractive PDF cue:** Furthermore, by Theorem 4.2. from [28], the probability that / ϕSARA f,1 (xi)⊤ϕSARA f,2 (yj) m exp(r2) - K(qi, kj)/ > τϵ is at most ...
...
- **p. 2 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** We consider a purely zero-shot attention-based control mechanism, where the action ai of the agent corresponding to the particular target ti (i = 1, ..., ...
- **p. 1 / Front matter - extractive PDF cue:** The manipulation policy is conditioned on the text instruction.
- **p. 1 / Front matter - extractive PDF cue:** 1: Robotics Transformer policies obtained via Self-Adaptive Robust Attention (SARA) in action for three different modalities: vision, language and point clouds and varying sequence lengths ...
- **p. 3 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** The VL navigation is a convenient "macroscopic" case study, but our main targets are Transformer-architectures for Robotics, where queries for the whole images or text ...
- **p. 3 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** This can be addressed algorithmically if K admits a bi-linearization, i.e. can be re-written as a linear (dot-product) kernel in the new input-space: K(x, y) ...
...
- **p. 4 / III. THE MATHEMATICS OF SARA-RTS - extractive PDF cue:** That completes the proof, since for m defined in the statement of the theorem, pϵ < 1.
...
- **p. 3 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** Learnable preprocessing corresponds here to fine-tuning matrices WQ and WK ([3]) from Transformers' attention modules, but in the linear attention context.
- **p. 3 / II. SELF-ADAPTIVE ROBUST ATTENTION VIA - extractive PDF cue:** We thus propose the process of the self-adaptation of their attention modules, that we refer to as up-training, which can be implemented as replacing regular ...
- **p. 5 / IV. EXPERIMENTS - extractive PDF cue:** Reported are mean inference times (averaged over l = 10 random seeds) for PCT encoders (as well as the corresponding standard deviations; see: shaded regions) ...
- **p. 4 / IV. EXPERIMENTS - extractive PDF cue:** 4: Training regular PCT policy as well as three variants of SARA with f ∈{ReLU, exp, sqrt} (up-training from the regular PCT checkpoint).
...
- **p. 5 / IV. EXPERIMENTS - extractive PDF cue:** For SARA variants (with f = ReLU and all-one vector v), up-training is conducted after the fine-tuning phase.
- **p. 4 / IV. EXPERIMENTS - extractive PDF cue:** A pass-through filter removes all points except for those of table top objects.
- **p. 4 / IV. EXPERIMENTS - extractive PDF cue:** The adaptation process of the linear attention for the ReLU variant is highlighted.
- **p. 5 / IV. EXPERIMENTS - extractive PDF cue:** We see almost immediate adaptation of the linear attention for all SARA variants.
- **p. 6 / IV. EXPERIMENTS - extractive PDF cue:** Frames are encoded via SARA variants of the ViTs (sViT).
- **p. 6 / IV. EXPERIMENTS - extractive PDF cue:** This self-attention block is yet another good candidate for injecting SARA variants.

...
`DayDreamer: World Models for Physical Robot Learning → TD-MPC2: Scalable, Robust World Models for Continuous Control → Control Barrier Function Based Quadratic Programs for Safety Critical Systems`

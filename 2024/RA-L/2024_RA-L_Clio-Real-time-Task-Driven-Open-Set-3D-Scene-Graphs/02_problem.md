...
- Abstract problem cue: We show that this problem can be naturally formulated using the Information Bottleneck (IB), an established information-theoretic framework.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Vision, Graph Reasoning` 관점의 개선을 제안한다.

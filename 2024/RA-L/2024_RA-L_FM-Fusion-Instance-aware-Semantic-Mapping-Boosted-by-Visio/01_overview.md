...
## Paper-Specific Cues
- Topic cue: Semantic mapping based on the supervised object detectors is sensitive to image distribution.
...
- Result cue: On the other hand, the development of vision-language foundation models demonstrates a strong zero-shot transferability across data distribution.
...
- 초록에서 확인되는 주요 cue: Semantic, Hence, Reading, RGB-D, ScanNet, SceneNN, Our.

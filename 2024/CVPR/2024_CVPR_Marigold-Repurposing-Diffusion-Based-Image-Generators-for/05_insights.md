...
- **Claim/result cue:** It delivers state-of-the-art performance across a wide range of datasets, including over 20% performance gains in specific cases.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `Diffusion, Generation, depth, 3D Vision`.

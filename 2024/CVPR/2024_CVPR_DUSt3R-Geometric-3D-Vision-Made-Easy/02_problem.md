...
- Abstract problem cue: Multi-view stereo reconstruction (MVS) in the wild requires to first estimate the camera parameters e.g. intrinsic and extrinsic parameters.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D reconstruction, calibration, geometry` 관점의 개선을 제안한다.

...
- Abstract problem cue: However learning-based robot manipulation trained on a limited category within a simulator often struggles to achieve generalizability especially when confronted with extensive categories.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `LLM, Robotics, Vision-Language` 관점의 개선을 제안한다.

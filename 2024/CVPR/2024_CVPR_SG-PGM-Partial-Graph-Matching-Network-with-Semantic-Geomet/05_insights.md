...
- **Claim/result cue:** Experiments show that our method improves the alignment accuracy by 10∼20% in low-overlap and random transformation scenarios and outperforms the existing work in multiple downstream tasks.

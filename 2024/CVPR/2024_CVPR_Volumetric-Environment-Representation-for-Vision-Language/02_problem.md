...
- Abstract problem cue: Vision-language navigation (VLN) requires an agent to navigate through an 3D environment based on visual observations and natural language instructions.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Navigation, 3D geometry, representation` 관점의 개선을 제안한다.

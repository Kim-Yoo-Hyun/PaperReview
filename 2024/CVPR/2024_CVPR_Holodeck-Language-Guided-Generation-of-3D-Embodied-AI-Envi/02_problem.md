...
- Abstract problem cue: 3D simulated environments play a critical role in Embodied AI but their creation requires expertise and extensive manual effort restricting their diversity and scope.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Generation, 3D scene, Embodied AI` 관점의 개선을 제안한다.

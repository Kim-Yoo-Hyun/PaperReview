...
- **Claim/result cue:** Experimental results demonstrate that the proposed HandDiff significantly outperforms the existing approaches on four challenging hand pose benchmark datasets.
...
- Registry position: `3D Generative Modeling`; tags: `geometry, Diffusion, Generation, point cloud, 3D Vision`.

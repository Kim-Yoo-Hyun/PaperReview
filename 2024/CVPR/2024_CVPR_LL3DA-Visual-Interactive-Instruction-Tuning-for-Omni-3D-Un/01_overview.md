...
- However, it is also challenging given 1) the diversity and complication of 3D environments and 2) the demands for understanding sparse 3D points.
...
## Main Claims
- Experiments show that LL3DA achieves remarkable results, and surpasses various 3D vision-language models on both 3D Dense Captioning and 3D Question Answering.
...
## Abstract Cue
- This help LMMs better comprehend human interactions and further help to remove the ambiguities in cluttered 3D scenes.

...
## Main Claims
- Furthermore, our benchmark experiments demonstrate that our approach has superior generalizability and robustness compared to state-of-the-art methods.
- We show that our proposed method achieves remarkable data efficiency, requiring only 5 to 10 human demonstrations for effective end-to-end training in less than an hour.
- Project Website: https : / / sites . google . com / view/diffusion-edfs hcw0221@ewhain.net Equivariant Descriptor Fields (EDFs) achieve dataefficient end-to-end learning on 6-DoF visual robotic manipulation tasks ...

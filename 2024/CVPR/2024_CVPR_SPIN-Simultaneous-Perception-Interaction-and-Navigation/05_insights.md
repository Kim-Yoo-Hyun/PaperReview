...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: In this work, we present a reactive mobile manipulation framework that uses an active visual system to consciously perceive and react to its environment.
- 출발 문제 단서: Prior works approach the problem using disentangled modular skills for mobility and manipulation that are trivially tied together.
- 주장된 효과 단서: Introduction Consider the example shown in Figure 2.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: Introduction Consider the example shown in Figure 2.
...
## 근거가 되는 논문 단서
- Problem cue: Prior works approach the problem using disentangled modular skills for mobility and manipulation that are trivially tied together.
- Method cue: In this work, we present a reactive mobile manipulation framework that uses an active visual system to consciously perceive and react to its environment.
- Result cue: Introduction Consider the example shown in Figure 2.

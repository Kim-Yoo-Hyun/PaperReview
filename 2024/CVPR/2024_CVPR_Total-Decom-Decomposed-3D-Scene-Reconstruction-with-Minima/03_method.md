...
- Our approach consistently delivers high-quality clean background reconstructions and reconstructs occluded areas.
...
## 핵심 방법론
- Our approach consistently delivers high-quality clean background reconstructions and reconstructs occluded areas.
- It is worth noting that our approach only requires 1.41 clicks on average per object, while ObjSDF++ requires dense human instance annotations on multi-view images.
- In reality, our approach can generally yield a more complete decomposition of the scene with more objects.

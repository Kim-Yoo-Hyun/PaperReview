...
- Abstract problem cue: However their efficacy heavily depends on neural networks that are resource-intensive in training and rendering.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, open-vocabulary, semantic` 관점의 개선을 제안한다.

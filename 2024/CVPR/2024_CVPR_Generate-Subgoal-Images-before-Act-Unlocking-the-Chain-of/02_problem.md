...
- Abstract problem cue: Moreover for long-horizon manipulation tasks the deviation from general instruction tends to accumulate if lack of intermediate guidance from high-level subgoals.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Diffusion, VLA, Planning` 관점의 개선을 제안한다.

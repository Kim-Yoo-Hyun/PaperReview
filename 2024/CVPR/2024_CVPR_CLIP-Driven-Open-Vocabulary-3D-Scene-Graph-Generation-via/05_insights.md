...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Specifically, we propose a novel Cross-Modality Contrastive Learning 3DSGG (CCL-3DSGG) method.
- 출발 문제 단서: However, current 3DSGG methods struggle with two main challenges.
- 주장된 효과 단서: Lastly, the recognition of novel object and predicate classes is achieved by calculating the cosine similarity between prompts and 3DSG features.

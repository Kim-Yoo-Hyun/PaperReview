...
- Abstract problem cue: Current multi-modal large language models however passively absorb sensory data as inputs lacking the capacity to actively interact with the objects in the 3D ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `LLM, 3D Vision, sensor fusion` 관점의 개선을 제안한다.

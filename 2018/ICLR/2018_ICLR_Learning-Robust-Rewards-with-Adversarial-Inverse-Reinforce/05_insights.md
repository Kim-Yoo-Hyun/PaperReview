...
- **Registry interface:** `Robotics, inverse reinforcement learning, adversarial learning, reward learning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
- Reuse the paper by preserving its input/output boundary and testing downstream success, failure, and latency under a matched baseline budget.

### Dependency and evolution

- Registry position: `Robotics Foundations: Robot Learning`; tags: `Robotics, inverse reinforcement learning, adversarial learning, reward learning`.
...
고정된 sensing/control rate에서 Robotics, inverse reinforcement learning, adversarial learning, reward learning interface가 직접 joint-action baseline보다 contact loss와 force/pose error를 줄이는가?

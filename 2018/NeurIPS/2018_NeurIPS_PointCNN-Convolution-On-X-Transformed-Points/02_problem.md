...
## 선행 연구 / 배경 단서
- We illustrate the problems and challenges of applying convolutions on point clouds in Figure 1.
- In this paper, we propose to learn a K × K X -transformation for the coordinates of K input points (p1 , p2 , ..., pK ), with ...
- Section 3 contains the details of X -Conv, as well as PointCNN architectures.

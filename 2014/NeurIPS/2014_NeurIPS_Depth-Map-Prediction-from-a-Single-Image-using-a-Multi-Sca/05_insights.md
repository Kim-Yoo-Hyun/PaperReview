...
- **Claim/result cue:** By leveraging the raw datasets as large sources of training data, our method achieves boundaries without the need for superpixelation.
...
- **Registry interface:** `3D Vision, monocular depth, geometry` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `3D Vision, monocular depth, geometry`.

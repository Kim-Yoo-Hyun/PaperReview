...
| Observation / input | (5a) This is a locally-linear feedback policy with k ≜-Q-1 uuQu and K ≜-Q-1 uuQux (5b) the feed-forward modification and feedback gain ... | joint/task state, reference와 sensor feedback | exact sensor/frame/preprocessing from PDF |
...
PDF contribution framing (p. 2 (I. INTRODUCTION), p. 2 (I. INTRODUCTION)): Finally, Section IV describes the results, illustrating the usefulness of our approach.
...
control writing domain maps to observation -> state/world model -> task and motion decision -> policy/control -> feedback. PDF interface anchors: p. 2 (II. DIFFERENTIAL DYNAMIC PROGRAMMING), p. 1 (Abstract), p. 1 (I. INTRODUCTION), p. 3 (C. Line Search). The downstream handoff is claimed only when the body describes it.

## Verification Questions

- **PDF anchors reviewed:** problem p. 1 (I. INTRODUCTION), p. 1 (I. INTRODUCTION), p. 2 (I. INTRODUCTION), p. 2 (I. INTRODUCTION), interface p. 2 (II. DIFFERENTIAL DYNAMIC PROGRAMMING), p. 1 (Abstract), p. 1 (I. INTRODUCTION), p. 3 (C. Line Search), objective p. 1 (Abstract), p. 1 (I. INTRODUCTION), p. 2 (II. DIFFERENTIAL DYNAMIC PROGRAMMING), p. 2 (II. DIFFERENTIAL DYNAMIC PROGRAMMING), p. 3 (III. CONTROL LIMITS), p. 3 (III. CONTROL LIMITS).

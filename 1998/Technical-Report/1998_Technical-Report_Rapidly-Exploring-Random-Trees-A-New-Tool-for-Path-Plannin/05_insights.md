...
`Probabilistic Roadmaps for Path Planning in High-Dimensional Configuration Spaces → Rapidly-Exploring Random Trees: A New Tool for Path Planning → CHOMP: Gradient Optimization Techniques for Efficient Motion Planning`

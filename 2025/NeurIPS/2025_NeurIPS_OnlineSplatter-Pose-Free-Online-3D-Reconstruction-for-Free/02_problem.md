...
- Abstract problem cue: Free-moving object reconstruction from monocular video remains challenging, particularly without reliable pose or depth cues and under arbitrary object motion.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, 3D reconstruction, geometry, 3D Vision` 관점의 개선을 제안한다.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: In this paper, we propose Segment then Splat, a 3D-aware open vocabulary segmentation approach for both static and dynamic scenes based on Gaussian Splatting.
- 출발 문제 단서: To solve this issue, most existing works [9–12] incorporate a separate language field alongside Gaussian Splatting reconstruction.
- 주장된 효과 단서: Extensive experiments on various datasets demonstrate the effectiveness of our proposed method in both static and dynamic scenarios.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: Extensive experiments on various datasets demonstrate the effectiveness of our proposed method in both static and dynamic scenarios.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: LERF / accuracy, mIoU, IoU, AP, mAP
...
## 근거가 되는 논문 단서
- Problem cue: To solve this issue, most existing works [9–12] incorporate a separate language field alongside Gaussian Splatting reconstruction.

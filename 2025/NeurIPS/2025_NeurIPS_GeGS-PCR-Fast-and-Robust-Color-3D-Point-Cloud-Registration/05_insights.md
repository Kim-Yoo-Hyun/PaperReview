...
- **Claim/result cue:** Our method achieves state-of-the-art performance with Registration Recall at 99.9%, Relative Rotation Error as low as 0.013, and Relative Translation Error as low as 0.024, improving precision by ...
...
- **Registry interface:** `geometry, sensor fusion, LiDAR, point cloud, 3D Vision` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Registration, and Equivariance`; tags: `geometry, sensor fusion, LiDAR, point cloud, 3D Vision`.

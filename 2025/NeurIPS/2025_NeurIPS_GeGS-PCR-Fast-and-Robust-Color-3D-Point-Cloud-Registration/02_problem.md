...
- Abstract problem cue: We address the challenge of point cloud registration using color information, where traditional methods relying solely on geometric features often struggle in low-overlap and ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `geometry, sensor fusion, LiDAR, point cloud` 관점의 개선을 제안한다.

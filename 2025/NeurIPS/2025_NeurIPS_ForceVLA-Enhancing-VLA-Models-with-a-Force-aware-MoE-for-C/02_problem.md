...
- Abstract problem cue: However, they struggle with contact-rich tasks that require fine-grained control involving force, especially under visual occlusion or dynamic uncertainty.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, Robotics` 관점의 개선을 제안한다.

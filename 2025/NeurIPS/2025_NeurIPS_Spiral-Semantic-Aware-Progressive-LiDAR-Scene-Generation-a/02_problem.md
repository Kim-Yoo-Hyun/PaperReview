...
- Abstract problem cue: While recent voxel-based approaches can generate both geometric structures and semantic labels, existing range-view methods are limited to producing unlabeled LiDAR scenes.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `sensor fusion, LiDAR, semantic, alignment` 관점의 개선을 제안한다.

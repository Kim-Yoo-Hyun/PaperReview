...
- Abstract problem cue: Multimodal Large Language Models (MLLMs) have demonstrated strong generalization in vision-language tasks, yet their ability to understand and act within embodied environments remains underexplored.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Navigation` 관점의 개선을 제안한다.

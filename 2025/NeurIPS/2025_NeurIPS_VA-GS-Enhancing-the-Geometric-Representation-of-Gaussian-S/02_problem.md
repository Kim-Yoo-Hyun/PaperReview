...
- Abstract problem cue: However, its capability for accurate surface reconstruction remains underexplored.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, semantic, alignment, 3D Vision` 관점의 개선을 제안한다.

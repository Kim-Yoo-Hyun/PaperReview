...
- **p. 6 / 4 Methodology - extractive body cue:** In the Unified NeRF training, gradients are also propagated to pose from reconstruction loss.
- **p. 7 / 4 Methodology - extractive body cue:** Finally, the overall optimization loss for MMG is defined as: LMMG = LIRCD + LPoint2Image.
- **p. 6 / 4 Methodology - extractive body cue:** (4), the optimization of both hash-grid and pose follows a coarse-to-fine strategy.
- **p. 8 / 4 Methodology - extractive body cue:** 4.3 Overall Optimization Pipeline Consistency Constraint.
- **p. 5 / 4 Methodology - extractive body cue:** To explore how modality features are fused, we independently truncate the gradients of reconstruction loss LCamera and LLiDAR to hash grids and geo-MLP.
...
- **p. 6 / 4 Methodology - extractive body cue:** In the early stages of optimization, only the gradients from the coarse resolution of the hash grids contribute to pose optimization, while the finer resolutions ...
- **p. 7 / 4 Methodology - extractive body cue:** Finally, the overall optimization loss for MMG is defined as: LMMG = LIRCD + LPoint2Image.
- **p. 7 / 4 Methodology - extractive body cue:** Based on these correspondences, we introduce a point-to-image error using photometric loss, which serves as a regularization term.
...
- **p. 5 / 4 Methodology - extractive body cue:** For the image modality, we use a lightweight MLP to refine the geo-MLP output, helping reduce modality conflicts.
- **p. 5 / 4 Methodology - extractive body cue:** Based on this observation, we propose a multimodal training method for optimizing the hash grid, which also stabilizes pose optimization and mitigates modality conflicts.
- **p. 7 / 4 Methodology - extractive body cue:** Leveraging the multimodal input, we exploit images to alleviate the impact of non-overlapping regions.
- **p. 2 / 1 Introduction - extractive body cue:** Nonetheless, when performing pose-free reconstruction and projecting discrete point clouds onto images for depth supervision, only a sparse set of pixels contains depth information, underutilizing ...
- **p. 4 / 3 Preliminaries - extractive body cue:** MUP is capable of performing NVS for both modalities, while also simultaneously recovering the vehicle poses P = {Ps/s = 0, 1, . . . ...
- **p. 4 / 3 Preliminaries - extractive body cue:** 𝐈𝐈𝐈𝐈𝐈𝐈𝐈𝐈𝐈𝐈 Intensity Point Cloud World Coordinate System 𝑷𝑷𝟏𝟏 𝑷𝑷𝟐𝟐 𝑷𝑷𝟑𝟑 POSE Reconstruction Loss 𝐃𝐃𝐃𝐃𝐃𝐃𝐃𝐃𝐃𝐃 Ground Truth Unified Neural LiDAR-Camera Fields Camera-Mask LiDAR-Mask 𝐅𝐅𝐅𝐅𝐅𝐅𝐅𝐅𝐞𝐞𝟏𝟏 𝐅𝐅𝐅𝐅𝐅𝐅𝐅𝐅𝐞𝐞s𝟐𝟐 𝐅𝐅𝐅𝐅𝐅𝐅𝐅𝐅𝐞𝐞𝟑𝟑 ...
- **p. 6 / 4 Methodology - extractive body cue:** Consequently, we adopt point cloud-based loss at the early stages and later employ image-based photometric loss to refine the poses.
...
- **p. 6 / 4 Methodology - extractive body cue:** In the Unified NeRF training, gradients are also propagated to pose from reconstruction loss.
- **p. 8 / 4 Methodology - extractive body cue:** 4.3 Overall Optimization Pipeline Consistency Constraint.
- **p. 6 / 4 Methodology - extractive body cue:** Pn+1 = Pn -(1 -w)lrGLiDAR -w · lrGCamera, (3) where G is the gradient of the corresponding modality, Pn denotes the pose at the n-th ...
...
- **p. 10 / 5 Experiment - extractive body cue:** Additionally, to further demonstrate the effectiveness of our multimodal approach, We conduct comparative experiments with the single-modality LiDAR-NeRF [36] and i-NGP [21], where i-NGP is ...
- **p. 9 / 5 Experiment - extractive body cue:** Ablation Study in pose-free setting.
- **p. 9 / 5 Experiment - extractive body cue:** All ablation studies are conducted on KITTI-360 [15].
- **p. 10 / 5 Experiment - extractive body cue:** Ablation of MSC2F and Consistency Loss.
...
- **p. 8 / 5 Experiment - extractive body cue:** For pose estimation, we follow [3], employing standard odometry metrics: Absolute Trajectory Error (ATE) and Relative Pose Error (RPE), with rotational (RPEr) and translational (RPEt) ...
...
- **Evidence anchors reviewed:** method p. 5 (4 Methodology), p. 5 (4 Methodology), p. 7 (4 Methodology), p. 6 (4 Methodology), p. 7 (4 Methodology), p. 6 (4 Methodology), objective p. 5 (4 Methodology), p. 6 (4 Methodology), p. 5 (4 Methodology), p. 6 (4 Methodology), p. 7 (4 Methodology), p. 7 (4 Methodology), temporal p. 10 (5 Experiment), p. 9 (5 Experiment), p. 5 (4 Methodology), p. 5 (4 Methodology), p. 6 (4 Methodology), p. 6 (4 Methodology).

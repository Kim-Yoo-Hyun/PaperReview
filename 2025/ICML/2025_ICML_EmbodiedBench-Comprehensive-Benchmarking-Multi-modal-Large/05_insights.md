...
- **Claim/result cue:** Through extensive experiments, we evaluated 24 leading proprietary and open-source MLLMs within E MBODIED B ENCH.
...
- **Registry interface:** `Benchmark` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Benchmarks and Datasets`; tags: `Benchmark`.

...
- Abstract problem cue: While language-centric embodied agents have garnered substantial attention, MLLM-based embodied agents remain underexplored due to the lack of comprehensive evaluation frameworks.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Benchmark` 관점의 개선을 제안한다.

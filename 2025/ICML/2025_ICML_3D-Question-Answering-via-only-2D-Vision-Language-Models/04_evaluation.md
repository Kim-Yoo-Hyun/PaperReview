...
- **p. 7 / 5. Experiments - extractive PDF cue:** SQA contains over 33K questionanswer pairs derived from 650 indoor scenes.
...
- **p. 5 / Figure/Table caption - extractive PDF cue:** Figure 5: Our viewAnnotator module operates in two steps: Caption Generation and View Matching (illustrated by light green boxes indicating outputs at each step). In ...
- **p. 7 / 5. Experiments - extractive PDF cue:** Furthermore, since the answers in ScanQA are often free-form, we use standard text similarity metrics, including BLEU-1 (Papineni et al., 2002), ROUGE-L (Lin, 2004), and ...
...
- **p. 9 / Figure/Table caption - extractive PDF cue:** Table 3: Computational performance comparison between image retrieval and cdViews for zero-shot 3D-QA. loss spatially close views, and thus miss critical information. cdViews's Efficiency. We ...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Figure 4: Performance comparison of view selection methods on the validation set of ScanQA (Azuma et al., 2022). It can be observed that: 1) performance ...
...
- **p. 1 / Figure/Table caption - extractive PDF cue:** Figure 1: Comparison of 3D Question Answering meth- ods. (a): a1 for 3D-based methods; a2 and a3 for hybrid (2D+3D) methods. All of these methods ...
- **p. 2 / Figure/Table caption - extractive PDF cue:** Figure 2: Comparison of view selection methods. (cdViews) and then use them to perform LVLMs-based 3D-QA in a zero-shot manner. cdViews is designed on two ...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Figure 3: The pipeline of zero-shot 3D-QA using three different view selection methods: uniform sampling (option ①), image retrieval (option ②), and our cdViews (option ...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Figure 4: Performance comparison of view selection methods on the validation set of ScanQA (Azuma et al., 2022). It can be observed that: 1) performance ...
- **p. 5 / Figure/Table caption - extractive PDF cue:** Figure 5: Our viewAnnotator module operates in two steps: Caption Generation and View Matching (illustrated by light green boxes indicating outputs at each step). In ...
- **p. 7 / Figure/Table caption - extractive PDF cue:** Table 1: Performance comparisons with the state-of-the-art methods on the test set of ScanQA (Azuma et al., 2022) and SQA (Ma et al., 2022). For ...
- **p. 8 / Figure/Table caption - extractive PDF cue:** Figure 6: Qualitative results for BridgeQA (Mo & Liu, 2024), LLAVA-OV + Fretrieval, and our final model LLAVA-OV + FcdViews. The marks , , and ...
- **p. 8 / Figure/Table caption - extractive PDF cue:** Table 2: An ablation study performed on ScanQA. We show the best EM@1 scores with the corresponding (optimal) k. selected views is shown in Figure ...
...
- **PDF anchors reviewed:** datasets p. 7 (5. Experiments), p. 7 (5. Experiments), metrics p. 7 (Figure/Table caption), p. 5 (Figure/Table caption), p. 7 (5. Experiments), p. 8 (Figure/Table caption), p. 9 (Figure/Table caption), p. 4 (Figure/Table caption), baselines p. 5 (Figure/Table caption), p. 7 (Figure/Table caption), p. 7 (5. Experiments), p. 8 (Figure/Table caption), p. 1 (Figure/Table caption), p. 2 (Figure/Table caption), results p. 5 (Figure/Table caption), p. 4 (Figure/Table caption), p. 7 (Figure/Table caption), p. 8 (Figure/Table caption), p. 8 (Figure/Table caption), p. 9 (Figure/Table caption).

...
- Chen et al. (2024a); Wen et al. (2024) pointed out that pretrained VLMs lack spat
...
## Main Claims
- Experimental results show that UP-VLA achieves a 33% improvement on the Calvin ABC-D benchmark compared to the previous state-of-the-art method.
- Additionally, UP-VLA demonstrates improved success rates in real-world manipulation tasks, particularly those requiring precise spatial information.
- Recent advancements in Vision-Language-Action (VLA) models have leveraged pre-trained VisionLanguage Models (VLMs) to improve the generalization capabilities.

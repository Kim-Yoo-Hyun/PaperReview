...
- **Claim/result cue:** Lastly, we propose a spherical denoising temporal U-net that achieves spatiotemporal equivariance with computational efficiency.
...
- **Registry interface:** `Robotics, Diffusion, Imitation Learning, equivariant` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `Robotics, Diffusion, Imitation Learning, equivariant`.

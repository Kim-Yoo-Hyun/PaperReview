...
- Abstract problem cue: However, specialized equivariant architectures limit the scalability and efficiency of diffusion models.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `semantic, alignment, Diffusion, Generation` 관점의 개선을 제안한다.

...
- Abstract problem cue: The effectiveness of scaling up training data in robotic manipulation is still limited.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Imitation Learning` 관점의 개선을 제안한다.

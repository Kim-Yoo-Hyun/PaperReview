...
- **Registry interface:** `Robotics, Imitation Learning, data curation, demonstrations` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
- Reuse the paper by preserving its input/output boundary and testing downstream success, failure, and latency under a matched baseline budget.

### Dependency and evolution

- Registry position: `Robot Learning and Data`; tags: `Robotics, Imitation Learning, data curation, demonstrations`.
...
고정된 data·compute·action budget에서 Robotics, Imitation Learning, data curation, demonstrations를 사용하는 방법이 단순 baseline보다 paper task metric과 closed-loop robustness를 함께 개선하는가?

...
- **p. 1 / Body text (section boundary not confidently recovered) - extractive body cue:** 1: Starting from a single expert demonstration and multi-view images, our method generates diverse and visu realistic data for policy learning, enabling robust performance across ...
...
|---|---|---|---|
| Horizon | single-step 또는 action chunk/trajectory horizon; exact chunk length는 exact value was not selected from the PDF body. | We employ a 3D SpaceMouse to collect teleoperated demonstrations at a frequency of 10 Hz, Policy inference is carried out on an ... | episode/sequence/action-chunk boundary |
...
- **Evidence anchors reviewed:** method p. 2 (A. Generalizable Policy in Robot Manipulation), p. 6 (C. Policy Training), p. 6 (C. Policy Training), p. 2 (B. Data Augmentation for Policy Learning), p. 3 (IV. METHODOLOGY), p. 3 (IV. METHODOLOGY), objective p. 5 (A. Reconstruction and Preprocessing), p. 6 (C. Policy Training), p. 6 (C. Policy Training), p. 4 (A. Reconstruction and Preprocessing), p. 2 (A. Generalizable Policy in Robot Manipulation), p. 4 (A. Reconstruction and Preprocessing), temporal p. 6 (A. Experimental Setup), p. 5 (1) Object Pose), p. 5 (4) Embodiment Type), p. 3 (IV. METHODOLOGY), p. 6 (A. Experimental Setup), p. 1 (Abstract).
...
- **Paper-specific method/interface:** The latent of images and robot state is fed into a transformer encoder. (p. 6, C. Policy Training).
- **Objective/update evidence:** The camera extrinsies are optimized through gradient descent, with the optimization objective: (p. 5, A. Reconstruction and Preprocessing).
- **Temporal/runtime evidence:** We employ a 3D SpaceMouse to collect teleoperated demonstrations at a frequency of 10 Hz, Policy inference is carried out on an NVIDIA RTX4090 GPU. with a latency of O.1s ... (p. 6, A. Experimental Setup).

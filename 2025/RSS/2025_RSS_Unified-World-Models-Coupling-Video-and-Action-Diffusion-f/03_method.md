...
- **Evidence anchors reviewed:** method p. 4 (III. METHOD), p. 3 (III. METHOD), p. 3 (III. METHOD), p. 4 (III. METHOD), objective p. 4 (III. METHOD), p. 4 (III. METHOD), p. 3 (III. METHOD), p. 3 (III. METHOD), temporal p. 3 (III. METHOD), p. 8 (IV. EXPERIMENTS), p. 3 (III. METHOD), p. 4 (III. METHOD), p. 4 (III. METHOD), p. 6 (IV. EXPERIMENTS).
...
- **Paper-specific method/interface:** Encoder Decoder Encoder Unpatchify Patchify Encoder Decoder Encoder Patchify Unified World Model Training UWM UWM Marginal Inference (Policy) 𝑡! 𝑡"# Conditional Inference (Inverse Dynamics) Encoder Decoder Encoder Patchify UWM 𝑡! ... (p. 4, III. METHOD).
- **Objective/update evidence:** This suggests a training recipe using a simple modification to the standard denoising objective [22]. (p. 4, III. METHOD).
- **Temporal/runtime evidence:** By setting timestep to′ = T, the joint model is approximating the expectation E [ϵa, ϵo′, /o, ata, o′ T ]. (p. 3, III. METHOD).

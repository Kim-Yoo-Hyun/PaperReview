...
| Observation / input | The trunk is an encoder-decoder Transformer, where the input sequence length and the output sequence length are both fixed, as the number ... | proprioception, terrain/perception observation과 velocity command | exact sensor/frame/preprocessing from PDF body |
...
locomotion writing domain maps to observation -> state/world model -> task and motion decision -> policy/control -> feedback. Evidence interface anchors: p. 6 (III. METHODOLOGY), p. 6 (III. METHODOLOGY), p. 5 (III. METHODOLOGY), p. 7 (III. METHODOLOGY). The downstream handoff is claimed only when the body describes it.

## Verification Questions

- **Evidence anchors reviewed:** problem p. 2 (I. INTRODUCTION), p. 1 (I. INTRODUCTION), p. 2 (I. INTRODUCTION), interface p. 6 (III. METHODOLOGY), p. 6 (III. METHODOLOGY), p. 5 (III. METHODOLOGY), p. 7 (III. METHODOLOGY), objective p. 6 (III. METHODOLOGY), p. 6 (III. METHODOLOGY), p. 7 (III. METHODOLOGY).

...
- Abstract problem cue: While this paradigm effectively utilizes large-scale data from both robotic and non-robotic sources, current VLAs primarily focus on direct input--output mappings, lacking the intermediate ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, Chain-of-Thought, Robotics` 관점의 개선을 제안한다.

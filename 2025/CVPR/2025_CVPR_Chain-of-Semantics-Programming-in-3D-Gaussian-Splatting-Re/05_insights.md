...
- **Claim/result cue:** In addition, it outperforms the recent supervised models on the Sr3D dataset.
...
- **Registry interface:** `Gaussian Splatting, semantic, grounding` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Language-Grounded 3D Scene Representations`; tags: `Gaussian Splatting, semantic, grounding`.

...
- Specifically, we first design a task-aware masked autoencoder that masks task-relevant ∗ : CLIP R3M VC-1 PointNet PointNet++ PointNeXt SPA DP3 Lift3D (DINOV2) Lift3D (CLIP) Type 2D Rep.
...
## 핵심 방법론
- CLIP R3M VC-1 PointNet PointNet++ PointNeXt SPA DP3 Lift3D (DINOV2) Lift3D (CLIP) Type 2D Rep.
- 3D Policy Ours Input Type RGB RGB RGB PC PC PC RGB PC PC PC Easy (7) 72.9 84.6 62.6 72.0 70.3 82.6 72.6 85.7 93.1 94.0 MetaWorld ...
- 65.3 75.1 60.8 55.9 61.6 68.7 69.5 65.3 84.5 83.9 Adroit Hammer Door 100 100 100 100 88 100 60 100 68 100 52 96 100 100 88 ...

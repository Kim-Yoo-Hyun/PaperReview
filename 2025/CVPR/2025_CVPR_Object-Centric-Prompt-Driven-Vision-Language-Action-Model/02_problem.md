...
- Abstract problem cue: However, natural language can be ambiguous, while images or videos may offer overly detailed specifications.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, prompting, Robotics` 관점의 개선을 제안한다.

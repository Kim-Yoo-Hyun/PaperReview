...
- Abstract problem cue: However, these models face significant challenges in spatial reasoning tasks, as their training data are based on general-purpose image datasets that often lack sophisticated ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLM, spatial reasoning, Robotics` 관점의 개선을 제안한다.

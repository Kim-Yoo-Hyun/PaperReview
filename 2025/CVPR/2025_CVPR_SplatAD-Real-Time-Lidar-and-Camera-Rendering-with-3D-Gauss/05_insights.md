...
- **Claim/result cue:** 3DGS provides an attractive alternative to NeRFs, as its accelerated rendering achieves comparable image realism while increasing inference speeds by an order of magnitude.

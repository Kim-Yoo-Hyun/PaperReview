...
- **Claim/result cue:** We evaluate our method on various 3D/4D tasks and demonstrate competitive or state-of-the-art performance in each.
...
- **Registry interface:** `3D reconstruction, SLAM, representation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `3D reconstruction, SLAM, representation`.

...
- **Claim/result cue:** Experiments demonstrate that PDFactor outperforms state-of-theart approaches across a diverse range of manipulation tasks in RLBench simulation.
...
- **Registry interface:** `Diffusion, Robotics, 3D action` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Manipulation, Contact, and Dexterity`; tags: `Diffusion, Robotics, 3D action`.

...
- Abstract problem cue: Robotic manipulation based on visual observations and natural language instructions is a long-standing challenge in robotics.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Diffusion, Robotics, 3D action` 관점의 개선을 제안한다.

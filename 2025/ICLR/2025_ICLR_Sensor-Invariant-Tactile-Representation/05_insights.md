...
- **Method cue:** For baseline models, we use similar pipelines as detailed in Section A.1.
...
- **Registry interface:** `Robotics, tactile sensing, sensor transfer, representation learning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Manipulation, Contact, and Dexterity`; tags: `Robotics, tactile sensing, sensor transfer, representation learning`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ImageNet / accuracy, mAP, RMSE

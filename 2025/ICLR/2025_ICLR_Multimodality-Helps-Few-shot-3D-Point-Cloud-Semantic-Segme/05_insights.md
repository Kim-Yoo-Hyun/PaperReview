...
- **Method cue:** This adaptive indicator ensures that the TACC module effectively mitigates training bias by dynamically calibrating predictions during test time, leading to improved few-shot generalization.
...
- **Registry interface:** `semantic, alignment, point cloud, 3D Vision` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Vision-Language Understanding`; tags: `semantic, alignment, point cloud, 3D Vision`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ScanNet, S3DIS / mIoU, IoU

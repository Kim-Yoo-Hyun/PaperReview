...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Avg.: the mean average Top1 accuracy across all categories. * denotes training from scratch.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: Objaverse / accuracy, mAP
...
## 근거가 되는 논문 단서
- Method cue: Avg.: the mean average Top1 accuracy across all categories. * denotes training from scratch.

...
PDF body evaluation/result cue (p. 8 (4 EXPERIMENTS), p. 8 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), p. 6 (4 EXPERIMENTS), p. 6 (4 EXPERIMENTS), p. 9 (4 EXPERIMENTS)): Freezing the original image VAE or its encoder results in poor performance, as Gaussian splat properties differ significantly from natural images.

## Evaluation Body Digest

- **p. 6 / 4 EXPERIMENTS - extractive body cue:** For both reconstruction and image-conditioned generation task, 300 objects from the unseen GSO (Downs et al., 2022) dataset are randomly selected and rendered to serve ...
...
- **p. 8 / 4 EXPERIMENTS - extractive body cue:** Rendering loss plays a crucial role in auto-encoding by ensuring that the VAE is supervised by real datasets rather than being limited by the lightweight ...
- **p. 9 / 4 EXPERIMENTS - extractive body cue:** Decoded splat latents from the image VAE can be interpreted as the original objects in a "special style" or illuminated in a "special environment light", ...
- **p. 6 / 4 EXPERIMENTS - extractive body cue:** Captions of these 3D objects are provided by Cap3D (Luo et al., 2023; 2024).
- **p. 7 / 4 EXPERIMENTS - extractive body cue:** DIFFSPLAT GVGEN LN3Diff DIRECT-3D 3DTopia LGM† GRM† Single Object ↑CLIP Sim.% 30.95 23.66 24.36 24.80 25.55 29.96 28.19 ↑CLIP R-Prec.% 81.00 23.25 27.25 30.75 34.50 ...
- **p. 8 / 4 EXPERIMENTS - extractive body cue:** Training Objectives DIFFSPLAT can perform well with merely the regular diffusion loss by setting λrender = 0 given high-quality splat latents.
- **p. 9 / 4 EXPERIMENTS - extractive body cue:** Gaussian splat property grids are analogous to natural images, reflecting the hue and edge properties of 3D objects.
...
- **p. 4 / Figure/Table caption - extractive body cue:** Figure 2: Method Overview. (1) A lightweight reconstruction model provides high-quality struc- tured representation for "pseudo" dataset curation. (2) Image VAE is fine-tuned to encode ...
- **p. 7 / Figure/Table caption - extractive body cue:** Figure 3: Qualitative Results and Comparisons on Text-conditioned 3D Generation. More visualizations of DIFFSPLAT results are provided in Appendix Figure 9, 10 and 11.
- **p. 7 / Figure/Table caption - extractive body cue:** Table 1: Quantitive evaluations on T3Bench prompts for text-conditioned generation. † indicates reconstruction-based methods that require additional text-conditioned multi-view generative models. DIFFSPLAT GVGEN LN3Diff DIRECT-3D ...
- **p. 8 / Figure/Table caption - extractive body cue:** Figure 4: Qualitative Results and Comparisons on Image-conditioned 3D Generation. More visualizations of DIFFSPLAT results are provided in Appendix Figure 12, 13 and 14.
- **p. 8 / Figure/Table caption - extractive body cue:** Table 2: Quantitative evaluations on GSO for image-conditioned generation. † indicates reconstruc- tion methods that require additional image generation models for single image-to-3D generation. DIFFSPLAT ...
- **p. 9 / Figure/Table caption - extractive body cue:** Figure 5: Controllable Generation. ControlNet can seamlessly adapt to DIFFSPLAT for control- lable text-to-3D generation in various formats, such as normal and depth maps, and ...
- **p. 9 / Figure/Table caption - extractive body cue:** Table 3: Ablation study of inputs for structured splat reconstruction. ↑PSNR ↑SSIM ↓LPIPS #Param. LGM 26.48

## Embodiment / Environment

| Dimension | PDF body-grounded cue | Unresolved condition | Anchor |
|---|---|---|---|
| Robot/hardware/simulator | For both reconstruction and image-conditioned generation task, 300 objects from the unseen GSO (Downs et al., 2022) dataset are randomly selected and rendered to ... | embodiment, simulator version and control stack | p. 6 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS) |
| Task/environment | Results and Comparisions Single image-conditioned generation performance on the GSO dataset is assessed in Table 2, and qualitative results on in-the-wild images are presented ... | reset, timeout, object/scene variation | p. 7 (4 EXPERIMENTS), p. 8 (4 EXPERIMENTS) |
...
| 29.87 0.961 0.028 42M Ours 30.09 0.963 0.027 42M Table 4: Ablation study for Gaussian splat property auto-encoding strategies. ↑PSNR ↑SSIM ↓LPIPS Frozen VAE ... | comparison identity and matched condition | p. 9 (4 EXPERIMENTS) |
...
- **p. 6 / 4 EXPERIMENTS - extractive body cue:** For both reconstruction and image-conditioned generation task, 300 objects from the unseen GSO (Downs et al., 2022) dataset are randomly selected and rendered to serve ...
- **p. 17 / A IMPLEMENTATION DETAILS - extractive body cue:** The flowbased model, i.e., SD3 (Esser et al., 2024) uses the original flow matching Euler ODE solver (Lipman et al., 2023) with 28 steps, consistent ...
- **p. 17 / A IMPLEMENTATION DETAILS - extractive body cue:** The flowbased model, i.e., SD3 (Esser et al., 2024) uses the original flow matching Euler ODE solver (Lipman et al., 2023) with 28 steps, consistent ...
...
- **Evidence anchors reviewed:** datasets p. 6 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), p. 8 (4 EXPERIMENTS), p. 9 (4 EXPERIMENTS), p. 6 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), metrics p. 6 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), p. 4 (Figure/Table caption), p. 8 (4 EXPERIMENTS), p. 9 (4 EXPERIMENTS), p. 10 (Figure/Table caption), baselines p. 6 (4 EXPERIMENTS), p. 6 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), p. 8 (4 EXPERIMENTS), p. 9 (4 EXPERIMENTS), results p. 8 (4 EXPERIMENTS), p. 8 (4 EXPERIMENTS), p. 7 (4 EXPERIMENTS), p. 6 (4 EXPERIMENTS), p. 6 (4 EXPERIMENTS), p. 9 (4 EXPERIMENTS).

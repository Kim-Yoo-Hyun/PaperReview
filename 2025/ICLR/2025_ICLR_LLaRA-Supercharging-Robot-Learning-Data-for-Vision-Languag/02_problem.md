...
- Abstract problem cue: However, directly adapting a pretrained VLM for robotic control remains challenging, particularly when constrained by a limited number of robot demonstrations.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model, Robotics` 관점의 개선을 제안한다.

...
- Abstract problem cue: However, existing LiDAR NVS methods typically rely on neural radiance fields (NeRF) as their 3D representation, which incurs significant computational costs in both training ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, sensor fusion, LiDAR, point cloud` 관점의 개선을 제안한다.

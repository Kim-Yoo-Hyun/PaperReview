...
- Abstract problem cue: In our exploration, we identify two key challenges in previous works on feature splatting: (1) computational constraints in storing high-dimensional features for each Gaussian ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, 3D Vision, Gaussian Splatting` 관점의 개선을 제안한다.

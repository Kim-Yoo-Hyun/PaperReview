...
- **Method cue:** Compared to OpenAD, which predicts regions based on a fixed set of affordance labels, our method utilizes longcontext understanding and reasoning for segmentation.
...
- **Registry interface:** `Robotics, 3D Vision, Reinforcement Learning, semantic` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `Robotics, 3D Vision, Reinforcement Learning, semantic`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ImageNet, Objaverse, PartNet / accuracy, mIoU, IoU, mAP, ADE

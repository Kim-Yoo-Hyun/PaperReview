...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Compared to OpenAD, which predicts regions based on a fixed set of affordance labels, our method utilizes longcontext understanding and reasoning for segmentation.

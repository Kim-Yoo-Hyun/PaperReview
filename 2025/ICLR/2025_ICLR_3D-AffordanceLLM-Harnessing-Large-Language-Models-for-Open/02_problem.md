...
- Abstract problem cue: This paradigm relies on predefined labels and lacks the ability to comprehend complex natural language, resulting in limited generalization in open-world scene.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, 3D Vision, Reinforcement Learning, semantic` 관점의 개선을 제안한다.

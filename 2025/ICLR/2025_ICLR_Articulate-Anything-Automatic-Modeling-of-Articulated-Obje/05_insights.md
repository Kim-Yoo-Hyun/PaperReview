...
- **Method cue:** We use the camera pose for all tasks.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ShapeNet, Objaverse, PartNet, PartNet-Mobility / accuracy, AP, Chamfer, success rate, collision

...
- **Method cue:** When trained on the more manageable mini-training set, we introduce an enhanced baseline, denoted as EmbodiedScan† , which achieves a 1.99% performance gain over the original EmbodiedScan.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ScanNet, Matterport3D, 3RScan, EmbodiedScan, ScanRefer / accuracy, IoU, mAP

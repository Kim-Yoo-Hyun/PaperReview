...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: When trained on the more manageable mini-training set, we introduce an enhanced baseline, denoted as EmbodiedScan† , which achieves a 1.99% performance gain over the original EmbodiedScan.

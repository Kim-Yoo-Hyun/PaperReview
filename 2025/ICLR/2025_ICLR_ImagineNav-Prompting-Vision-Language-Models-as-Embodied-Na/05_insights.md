...
- **Method cue:** FBE (Topiwala et al., 2018) SemExp (Chaplot et al., 2020) Habitat-Web (Ramrakhya et al., 2022) OVRL (Yadav et al., 2022) ESC (Zhou et al., 2023) VoroNav (Wu et ...
...
- Recorded scope boundary/future cue:
  - 저자가 남긴 확장 방향: By incorporating imagination mechanism, the system effectively predicts future waypoints, transforming traditional navigation planning into a visual selection task for the VLM.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: Matterport3D, Habitat, HM3D / mAP, SPL, SR, success rate, collision

...
- Abstract problem cue: However, extensive demonstrations are required for policy robustness and generalization.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Diffusion, equivariant` 관점의 개선을 제안한다.

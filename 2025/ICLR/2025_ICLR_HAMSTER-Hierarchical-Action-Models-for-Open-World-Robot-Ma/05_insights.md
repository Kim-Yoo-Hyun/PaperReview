...
- **Method cue:** We test HAMSTER+RVT2 against OpenVLA from a new camera angle (Figure 6) across 10 pick-and-place trials using 6 training objects and 3 training containers to
...
- **Registry interface:** `Robotics, Reinforcement Learning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `Robotics, Reinforcement Learning`.

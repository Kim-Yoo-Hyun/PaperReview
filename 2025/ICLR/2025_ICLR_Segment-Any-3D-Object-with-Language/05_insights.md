...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We compare SOLE mainly with recent mask-training methods (Takmaz et al., 2023; Huang et al., 2023b; Nguyen et al., 2024).
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: ScanNet, ScanNet200, Replica / accuracy, IoU, AP, mAP
...
## 근거가 되는 논문 단서
- Method cue: We compare SOLE mainly with recent mask-training methods (Takmaz et al., 2023; Huang et al., 2023b; Nguyen et al., 2024).

...
- **Registry interface:** `Robotics, multi-robot, motion planning, diffusion model` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Multi-Robot Systems`; tags: `Robotics, multi-robot, motion planning, diffusion model`.

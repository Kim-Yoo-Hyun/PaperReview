...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Additionally, for mesh evaluation, we use metrics including Accuracy, Completion, Chamfer-L1 distance, Normal Consistency, and F-scores.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: ScanNet, Replica / accuracy, mAP, Chamfer, F-score, PSNR
...
## 근거가 되는 논문 단서
- Method cue: Additionally, for mesh evaluation, we use metrics including Accuracy, Completion, Chamfer-L1 distance, Normal Consistency, and F-scores.

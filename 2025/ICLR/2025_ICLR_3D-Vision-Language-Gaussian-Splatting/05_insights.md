...
- **Method cue:** Feature-3DGS CVPR’24 43.7 58.8 40.5 39.6 45.7 LEGaussians CVPR’24 46.0 60.3 40.8 39.4 46.9 LangSplat CVPR’24 51.2 65.1 44.7 44.5 51.4 GS-Grouping ECCV’24 45.5 60.9 40.0 38.7 46.3 ...
...
- **Registry interface:** `Vision-Language Model, 3D Vision, Gaussian Splatting, semantic` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Language-Grounded 3D Scene Representations`; tags: `Vision-Language Model, 3D Vision, Gaussian Splatting, semantic`.

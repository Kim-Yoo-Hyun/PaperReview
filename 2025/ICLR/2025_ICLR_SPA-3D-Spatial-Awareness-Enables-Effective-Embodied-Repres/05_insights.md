...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Input Size Patch Size #Param. #Frames Multi-Modal InternViT-300M InternViT-6B Embodied-Specific MVP VC-1 CLIP EVA (Chen et al., 2020b) (He et al., 2022) (Oquab et al., 2023) (Radford et ...
- 주장된 효과 단서: The results on each benchmark are shown in Tab.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: The results on each benchmark are shown in Tab.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: ImageNet, ScanNet, S3DIS, RLBench, LIBERO / mAP, success rate
...
## 근거가 되는 논문 단서
- Method cue: Input Size Patch Size #Param. #Frames Multi-Modal InternViT-300M InternViT-6B Embodied-Specific MVP VC-1 CLIP EVA (Chen et al., 2020b) (He et al., 2022) (Oquab et al., 2023) (Radford et ...
- Result cue: The results on each benchmark are shown in Tab.

...
- **Method cue:** TraceVLA finetuned OpenVLA finetuned LIBERO-Spatial 84.6% ± 0.2% 82.6% ± 0.4% LIBERO-Object 85.2% ± 0.4% 83.8% ± 0.6% LIBERO-Goal 75.1% ± 0.3% 70.4% ± 0.5% LIBERO-Long 54.1% ± ...
...
- **Registry interface:** `VLA, Robotics, 3D Vision` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `VLA, Robotics, 3D Vision`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: LIBERO, BridgeData, Open X-Embodiment / accuracy, success rate, collision, ADE

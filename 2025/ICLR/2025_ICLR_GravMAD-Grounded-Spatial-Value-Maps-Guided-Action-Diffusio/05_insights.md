# Insights — GravMAD: Grounded Spatial Value Maps Guided Action Diffusion for Generalized 3D Manipulation
...
- **Registry interface:** `Robotics, 3D Vision, Diffusion, Imitation Learning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `VLA and Generalist Robot Policies`; tags: `Robotics, 3D Vision, Diffusion, Imitation Learning`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: RLBench / accuracy, AP, mAP, success rate

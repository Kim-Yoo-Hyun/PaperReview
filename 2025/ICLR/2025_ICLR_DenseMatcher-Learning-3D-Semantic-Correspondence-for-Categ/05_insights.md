...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: From our training objective in Eq 4.3.1, the feature distance should be linearly proportional to the semantic distance function, assuming our training objective is fully optimized.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: ImageNet, Objaverse / accuracy, AP, mAP, success rate
...
## 근거가 되는 논문 단서
- Method cue: From our training objective in Eq 4.3.1, the feature distance should be linearly proportional to the semantic distance function, assuming our training objective is fully optimized.

...
- Recent efforts to bridge 3D visual information with textual and other modalities show potential in 3D visual understanding and reasoning.
...
## Abstract Cue
- This paper introduces Scene-LLM, a 3D-visuallanguage model that enhances embodied agents’ abilities in interactive 3D indoor environments by integrating the reasoning strengths of Large Language Models (LLMs).

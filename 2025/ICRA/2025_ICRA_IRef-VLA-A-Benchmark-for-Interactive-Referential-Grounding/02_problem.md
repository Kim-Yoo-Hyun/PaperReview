...
- Abstract problem cue: However, despite recent progress, this problem remains challenging due to the 3D spatial reasoning and semantic understanding required.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, 3D Vision, Benchmark` 관점의 개선을 제안한다.

...
- **Claim/result cue:** In practice, we observe significant improvements over state-of-the-art methods by up to 50% increase in navigation success rate.
...
- **Registry interface:** `Vision-Language Model, Robotics, Navigation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Embodied Navigation and Mapping`; tags: `Vision-Language Model, Robotics, Navigation`.

...
## Paper-Specific Cues
- Topic cue: Current open-vocabulary scene graph generation algorithms highly rely on both 3D scene point cloud data and posed RGB-D images and thus have limited applications ...
- Method cue: To solve this problem, we propose Point2Graph, a novel end-to-end point cloud-based 3D open-vocabulary scene graph generation framework in which the requirement of posed ...
- Result cue: Our evaluation results show that our framework can outperform the current state-of-the-art (SOTA) open-vocabulary object and room segmentation and classification algorithm on widely used ...
...
- 핵심 키워드: Robotics, 3D Vision, Navigation, Graph Reasoning, semantic.
- 초록에서 확인되는 주요 cue: Current, RGB-D, Point2Graph, This, For, Snap-Lookup, Our, SOTA.

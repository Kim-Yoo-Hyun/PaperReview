...
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** In this task, the robot has to navigate to a USB cable, unplug it from its holder, and plug it into the last port of ...
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** 6. t-SNE plot comparing the latent space of a demonstration (from the cable plugging testing dataset) before and after visuo-tactile pretraining, showing how pretraining aligns ...
- **p. 6 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** For both pretrained and non-pretrained tactileonly diffusion policies, the robot would pick up the USB cable, but then would alternate between trying to move back ...
...
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** Comparing the two imitation learning methods, we found that Diffusion Policy's success rate was less sensitive than ACT, with a higher accuracy for the non-pretrained ...
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** We found that by pretraining a visuo-tactile agent, we were able to solve the cable plugging task, reaching a 95% success rate for ACT.
- **p. 6 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** Success rate for our experiment tasks.
- **p. 6 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** All experiments were run 20 times, with the total success rate shown.
...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Fig. 3. Imitation learning networks. ACT (left) is trained as an autoencoder, predicting a sequence of actions at each timestep (at). At inference, the latent ...
...
- **p. 5 / Figure/Table caption - extractive PDF cue:** Fig. 5. GelSight sensor outputs, showing the RGB images from the GelSight's camera and the processed strain data for both the covered and uncovered gelsight. ...
- **p. 5 / Figure/Table caption - extractive PDF cue:** Fig. 6. t-SNE plot comparing the latent space of a demonstration (from the cable plugging testing dataset) before and after visuo-tactile pretraining, showing how pretraining ...
- **p. 6 / Figure/Table caption - extractive PDF cue:** Fig. 7. Success rate for our experiment tasks. All experiments were run 20 times, with the total success rate shown. The use of visuo-tactile pretraining ...
...
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** Diffusion's longer re-plan horizon (re-planning every 8 steps instead of every step) and stochastic nature lead to larger motions, tending to jump around the port ...
- **p. 4 / III. METHODS - extractive PDF cue:** We take advantage of noise scheduler decoupling, using 100 denoising steps during training and 10 steps at inference.
- **p. 4 / III. METHODS - extractive PDF cue:** The data collection system was run at 10 Hz.
- **p. 5 / III. METHODS - extractive PDF cue:** The strain map is rendered in the LAB color space, with the brightness of each pixel corresponding to the normal strain (depth), and the color ...
...
- **p. 6 / V. CONCLUSIONS - extractive PDF cue:** A major limitation of this work is that task-specific data was used for pretraining.
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** Although this is relatively small in absolute terms, it corresponds to a 50% and 20% decrease in failures for ACT and Diffusion Policy, respectively.
- **p. 6 / V. CONCLUSIONS - extractive PDF cue:** Evaluating this alternative approach is left for future work.
- **p. 4 / Figure/Table caption - extractive PDF cue:** Fig. 3. Imitation learning networks. ACT (left) is trained as an autoencoder, predicting a sequence of actions at each timestep (at). At inference, the latent ...
- **p. 5 / IV. EXPERIMENTAL EVALUATION - extractive PDF cue:** To increase the task's difficulty, we added random noise with a standard deviation of 2.5mm to the agent's actions during inference.

- **PDF anchors reviewed:** datasets p. 5 (IV. EXPERIMENTAL EVALUATION), p. 5 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), metrics p. 5 (IV. EXPERIMENTAL EVALUATION), p. 5 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), p. 1 (Figure/Table caption), p. 3 (Figure/Table caption), baselines p. 5 (IV. EXPERIMENTAL EVALUATION), p. 5 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), p. 1 (Figure/Table caption), p. 4 (Figure/Table caption), results p. 5 (IV. EXPERIMENTAL EVALUATION), p. 6 (IV. EXPERIMENTAL EVALUATION), p. 6 (Figure/Table caption), p. 5 (IV. EXPERIMENTAL EVALUATION).

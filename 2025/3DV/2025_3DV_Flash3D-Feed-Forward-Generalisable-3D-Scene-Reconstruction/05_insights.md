...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We propose Flash3D, a method for scene reconstruction and novel view synthesis from a single image which is both very generalisable and efficient.
- 출발 문제 단서: Introduction We consider the problem of reconstructing photorealistic 3D scenes from a single image in just one forward pass of a network.
- 주장된 효과 단서: It achieves state-of-the-art results when trained and tested on RealEstate10k.

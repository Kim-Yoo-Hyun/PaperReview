...
- **Claim/result cue:** Our method not only far outperforms prior gradientdescent based bundle adjustment methods, but surprisingly approaches the accuracy of COLMAP, the state-ofthe-art SfM method, on the downstream task of ...
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `geometry, depth, 3D Vision`.

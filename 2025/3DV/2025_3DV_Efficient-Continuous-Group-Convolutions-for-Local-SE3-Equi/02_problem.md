...
- Abstract problem cue: However, extending the equivariant properties of a convolution layer comes at a computational cost.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `equivariant, point cloud, 3D Vision` 관점의 개선을 제안한다.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We present a system for quadrupedal mobile manipulation in indoor environments.
- 출발 문제 단서: However, several challenges prevent quadrupeds from learning helpful indoor skills that require interaction with environments and humans: lack of end-effectors for manipulation, limited semantic understanding using only simulation ...
- 주장된 효과 단서: — Learning-based methods have achieved strong performance for quadrupedal locomotion.

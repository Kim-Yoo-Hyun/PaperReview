...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We present the navigation results for each scene in Tab.
- 출발 문제 단서: To tackle this challenge, the robot must capture and update scene changes and plans continuously.
- 주장된 효과 단서: The results demonstrate that by updating the CRSG, the robot can efficiently navigate to moved targets.

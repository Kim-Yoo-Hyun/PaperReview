...
- Abstract problem cue: However existing RL methods suffer from high sample complexity, poor sim-to-real transfer, and limited runtime adaptability to navigation scenarios not seen during training.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Navigation, Gaussian Splatting` 관점의 개선을 제안한다.

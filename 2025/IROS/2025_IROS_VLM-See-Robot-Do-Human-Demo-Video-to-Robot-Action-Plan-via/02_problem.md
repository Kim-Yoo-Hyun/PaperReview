...
- Although language instructions are effective in many scenarios, some tasks are inherently difficult to describe precisely using plain language.

## 해결하려는 문제
- To validate our approach, we collected a set of long-horizon human videos demonstrating pick-and-place tasks in three diverse categories and designed a set of metrics to comprehensively benchmark ...
- Existing work has applied VLMs to generate task and motion planning from natural language instructions and simulate training data for robot learning.
- The experiments demonstrate SeeDo’s superior performance.

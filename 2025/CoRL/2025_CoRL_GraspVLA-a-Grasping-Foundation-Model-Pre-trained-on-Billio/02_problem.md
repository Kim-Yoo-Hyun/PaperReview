...
- Abstract problem cue: However, existing models rely heavily on real-world data, which is costly and labor-intensive to collect.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, grasping, synthetic data` 관점의 개선을 제안한다.

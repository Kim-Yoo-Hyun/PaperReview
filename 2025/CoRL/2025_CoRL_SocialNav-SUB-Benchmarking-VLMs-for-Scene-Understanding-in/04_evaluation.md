...
- **p. 14 / 7 Appendix - extractive PDF cue:** 7.1 Waypoint Selection Experiments To further demonstrate the practical value of SOCIALNAV-SUB in real-world social robot navigation, we conduct preliminary experiments examining how scene understanding ...
- **p. 14 / 7 Appendix - extractive PDF cue:** Our SOCIALNAV-SUB benchmark provides the community with a valuable dataset and evaluation toolkit to support exploration along this direction.
- **p. 15 / 7 Appendix - extractive PDF cue:** These illustrate variation in environment type, crowd density, and human-robot proximity.
- **p. 19 / 7 Appendix - extractive PDF cue:** Overall 15.0% failure rate; higher at blind corners (17.3% vs 14.9%); failure cases show more people in scene (12.26 vs 11.91); Robot Action to Person: ...
- **p. 22 / 7 Appendix - extractive PDF cue:** These results highlight the deficiencies of non-reasoning VLMs: 1) Gemini [7] has stronger social reasoning than other non-reasoning VLMs for most questions but has worse ...
- **p. 15 / 7 Appendix - extractive PDF cue:** SOCIALNAV-SUB comprises 60 social robot navigation scenarios in total.
- **p. 18 / 7 Appendix - extractive PDF cue:** Bottom-left: GPT-4o correctly answers that person 5 is on the left, whereas both Gemini and LLaVa-Next-Video answer that person 5 is behind the robot.
- **p. 18 / 7 Appendix - extractive PDF cue:** Bottom-right: Most VLMs (but not all) predict that person 6 is being considered as the robot is moving towards the goal, similar to the distribution ...
...
- **p. 2 / Figure/Table caption - extractive PDF cue:** Figure 1: Examples of social robot navigation scenarios from SCAND [4]. The ability to de- termine socially compliant navigation actions requires understanding each dynamic scene ...
- **p. 3 / Figure/Table caption - extractive PDF cue:** Figure 2: An overview of SOCIALNAV-SUB, which facilitates the systematic evaluation of VLMs in social robot navigation scenarios. Using SCAND data, human-labeled VQA datasets, and ...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Figure 3: The data processing pipeline for VQA prompts in SOCIALNAV-SUB. We first mine social robot navigation scenarios from SCAND [4], then use the PHALP ...
- **p. 7 / Figure/Table caption - extractive PDF cue:** Table 1: Average Performance Across Question Categories. The metrics used are PA and CWPA for all questions and for each question category, along with standard ...
...
- **p. 14 / Figure/Table caption - extractive PDF cue:** Figure 4: An example of the waypoint selection VQA task. This particular example highlights using scene context from the human oracle. Having no context removes ...
- **p. 14 / Figure/Table caption - extractive PDF cue:** Table 3: Accuracy of various VLMs in selecting the same waypoint as the human operator under social scene contexts from different sources: a random generator, ...
- **p. 15 / Figure/Table caption - extractive PDF cue:** Figure 5: Examples of scenes from SOCIALNAV-SUB. These illustrate variation in environment type, crowd density, and human-robot proximity. SOCIALNAV-SUB comprises 60 social robot navigation scenarios ...
...
- **p. 15 / 7 Appendix - extractive PDF cue:** Estimates achieve an average displacement error of 0.67±0.14 m across all samples.
- **p. 20 / 7 Appendix - extractive PDF cue:** 399 Robot Action to Person: The high-level relational action of the robot with respect to the person (e.g., the robot avoided person 2).
- **p. 20 / 7 Appendix - extractive PDF cue:** 399 Robot Affected by Person at End: Whether the robot's (human operator's) actions are affected by the person at the end of the video.
- **p. 20 / 7 Appendix - extractive PDF cue:** 399 Robot Action to Person at End: The high-level relational action of the robot with respect to the person at the end of the video.
...
- **p. 24 / 7 Appendix - extractive PDF cue:** Question Name CoT CoT with Ground-Truth Spatial(Temporal) Reasoning PA CW PA PA CW PA Robot Affected by Person 0.64 ± 0.02 0.78 ± 0.02 0.78 ...
...
- **p. 17 / 7 Appendix - extractive PDF cue:** 7.6 Failure Case Analysis As mentioned in Section 4.2, we found cases of VLMs in the experiment failing on questions with high human consensus in ...
- **p. 18 / Figure/Table caption - extractive PDF cue:** Figure 9: Examples of failure cases for VLMs. Top-left: Failing to recognize that person 5 is on the left. Top-right: Failing to recognize that person ...
- **p. 19 / 7 Appendix - extractive PDF cue:** Overall FR is the model's failure rate with standard error in smaller type.
- **p. 19 / 7 Appendix - extractive PDF cue:** Overall 33.8% failure rate; very limited Robot Action to Person diversity-only avoiding (53.1%) and not considering (6.38%).
- **p. 15 / 7 Appendix - extractive PDF cue:** Since SCAND does not provide 3D human pose labels, we validated this pipeline and tuned the hyperparameters on the CODa dataset [41], which provides high-quality ...

- **PDF anchors reviewed:** datasets p. 14 (7 Appendix), p. 14 (7 Appendix), p. 15 (7 Appendix), p. 19 (7 Appendix), p. 22 (7 Appendix), p. 15 (7 Appendix), metrics p. 14 (7 Appendix), p. 7 (Figure/Table caption), p. 19 (7 Appendix), p. 19 (7 Appendix), p. 14 (7 Appendix), p. 15 (7 Appendix), baselines p. 3 (Figure/Table caption), p. 14 (7 Appendix), p. 23 (7 Appendix), p. 8 (Figure/Table caption), p. 14 (7 Appendix), p. 21 (7 Appendix), results p. 14 (7 Appendix), p. 23 (7 Appendix), p. 24 (7 Appendix), p. 15 (7 Appendix), p. 7 (Figure/Table caption), p. 14 (7 Appendix).

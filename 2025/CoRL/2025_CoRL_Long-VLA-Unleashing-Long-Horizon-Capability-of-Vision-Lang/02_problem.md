...
- Abstract problem cue: However, existing VLA frameworks primarily address short-horizon tasks, and their effectiveness on long-horizon, multi-step robotic manipulation remains limited due to challenges in skill chaining ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, Planning, Robotics` 관점의 개선을 제안한다.

...
| Observation / input | Input Images Ours (Render w/ pred. poses) PF-LRM (Render w/ pred. poses) Novel G.T. | RGB-D, image set, point cloud, depth와 camera pose | exact sensor/frame/preprocessing from PDF body |

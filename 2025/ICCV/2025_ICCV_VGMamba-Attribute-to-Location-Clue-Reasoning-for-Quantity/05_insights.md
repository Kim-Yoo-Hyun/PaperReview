...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Particularly, we propose a VGMamba network that consists of an SVD-based attribute mamba, location mamba, and multi-modal fusion mamba.
- 출발 문제 단서: Most existing methods often follow a two-stage process, i.e., ﬁrst detecting proposal objects and identifying the right objects based on the relevance to the given query.
- 주장된 효과 단서: Extensive experimental results demonstrate the superiority of our method.

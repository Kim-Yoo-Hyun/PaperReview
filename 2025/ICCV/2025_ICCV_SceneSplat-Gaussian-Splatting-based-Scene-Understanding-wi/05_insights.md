...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: Furthermore, we propose a self-supervised 1.
- 출발 문제 단서: To address these limitations, we introduce SceneSplat in Fig.
- 주장된 효과 단서: Recognizing arbitrary or previously unseen categories is essential for comprehensive real-world 3D scene understanding.
...
- Result cue: Recognizing arbitrary or previously unseen categories is essential for comprehensive real-world 3D scene understanding.

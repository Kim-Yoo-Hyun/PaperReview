...
- **Method cue:** Furthermore, we propose a self-supervised 1.
- **Problem cue:** To address these limitations, we introduce SceneSplat in Fig.
- **Claim/result cue:** Recognizing arbitrary or previously unseen categories is essential for comprehensive real-world 3D scene understanding.
...
- **Registry interface:** `Gaussian Splatting, Vision-Language, semantic` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Language-Grounded 3D Scene Representations`; tags: `Gaussian Splatting, Vision-Language, semantic`.
- A direct citation predecessor/successor is not recorded in the legacy note; confirm it from references and the track synthesis before asserting lineage.
- Recorded scope boundary/future cue:
  - 논문이 도달한 지점: Recognizing arbitrary or previously unseen categories is essential for comprehensive real-world 3D scene understanding.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ScanNet, ScanNet200, Matterport3D, Replica, 3RScan / accuracy, mIoU, IoU, mAP, PSNR

...
- **p. 4 / 4. Experiment - extractive body cue:** Tasks, datasets, and metric nuScenes [3]: For 3D occupancy estimation, we utilize annotations from Occ3D [40].
...
- **p. 8 / Figure/Table caption - extractive body cue:** Table 7. Comparison of rendering efficiency between volume ren- dering (VR) [53] and splatting rendering (SR, Ours) on 3D occu- pancy estimation task [3]. The ...
...
- **p. 7 / Figure/Table caption - extractive body cue:** Figure 5. The comparison of the depth map and its synthesis over- lap image with (1) direct bilinear interpolation cross-view synthe- sis [43] and (2) ...
- **p. 8 / Figure/Table caption - extractive body cue:** Table 4. Comparison of pose type for stage 2 training on depth estimation task [3]. One stage training directly uses the cross-view loss to the ...
...
- **p. 3 / Figure/Table caption - extractive body cue:** Figure 2. GaussianOcc is a two-stage method. In Stage 1, we train a scale-aware 6D pose network, using a U-Net architecture to predict Gaussian attributes ...
- **p. 4 / Figure/Table caption - extractive body cue:** Figure 3. Overlap mask in nuScenes [3] and DDAD [13]. though we have the vertices at that region during the splat- ting rendering, after the ...
- **p. 5 / Figure/Table caption - extractive body cue:** Table 1. 3D occupancy comparison on the Occ3D dataset with mIoU metric. Since ‘other' and ‘other flat' classes are the invalid prompts for open-vocabulary models, ...
- **p. 5 / Figure/Table caption - extractive body cue:** Figure 2. In stage 1, we jointly train the depth estimation network and the 6D pose net, where we train the models for 8 epochs ...
...
- **p. 6 / Figure/Table caption - extractive body cue:** Figure 4. Visualization of the render depth map and 3D occupancy prediction on the nuScenes and DDAD datasets. 28985
...
- **p. 5 / 4.2. Implementation details - extractive body cue:** In stage 1, we jointly train the depth estimation network and the 6D pose net, where we train the models for 8 epochs on the ...
- **p. 5 / 4.2. Implementation details - extractive body cue:** We train the models for 12 epochs on both the nuScenes and DDAD.
- **p. 5 / 4.3. Main results - extractive body cue:** This discrepancy might be attributed to differences in perception range-80 meters in nuScenes versus 200 meters in DDAD.
- **p. 5 / 4.2. Implementation details - extractive body cue:** In the depth estimation benchmark, we use the network proposed by SimpleOcc, where the final output size is 256×256×16.
...
- **Evidence anchors reviewed:** datasets p. 4 (4. Experiment), p. 5 (4.3. Main results), p. 5 (4.2. Implementation details), metrics p. 7 (Figure/Table caption), p. 8 (Figure/Table caption), p. 5 (4.3. Main results), p. 5 (4.3. Main results), p. 7 (Figure/Table caption), p. 8 (Figure/Table caption), baselines p. 5 (4.3. Main results), p. 5 (4.3. Main results), p. 7 (Figure/Table caption), p. 8 (Figure/Table caption), p. 6 (Figure/Table caption), p. 8 (Figure/Table caption), results p. 5 (4.3. Main results), p. 5 (4.3. Main results), p. 6 (Figure/Table caption).

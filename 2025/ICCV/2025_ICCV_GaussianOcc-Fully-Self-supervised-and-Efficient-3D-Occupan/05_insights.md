...
- **Claim/result cue:** Existing methods achieve self-supervised learning through volume rendering, where the 2D semantic map supervision is derived from open-vocabulary semantic segmentation , and the depth map supervision is obtained ...

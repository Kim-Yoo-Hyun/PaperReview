...
- Abstract problem cue: However, due to the computational intensity of 3DGS optimization and the large search space of 6-DoF camera pose, directly leveraging 3DGS for image localization ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Vision, Navigation, Gaussian Splatting` 관점의 개선을 제안한다.

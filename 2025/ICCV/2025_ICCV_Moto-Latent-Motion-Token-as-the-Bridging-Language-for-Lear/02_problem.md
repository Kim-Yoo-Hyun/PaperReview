...
- Abstract problem cue: The key challenge is to identify an effective representation for autoregressive pre-training that benefits robot manipulation tasks.Inspired by the way humans learn new skills ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics` 관점의 개선을 제안한다.

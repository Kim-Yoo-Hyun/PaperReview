...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: In particular, we introduce two untargeted attack objectives that leverage spatial foundations to destabilize robotic actions, and a targeted attack objective that manipulates the robotic trajectory.
- 출발 문제 단서: Failure Rate Comparison 100% 90% 80% LIBERO B.
- 주장된 효과 단서: This paper systematically evaluates their robustness.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: This paper systematically evaluates their robustness.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: LIBERO, BridgeData / AP, SR, success rate
...
## 근거가 되는 논문 단서
- Problem cue: Failure Rate Comparison 100% 90% 80% LIBERO B.
- Method cue: In particular, we introduce two untargeted attack objectives that leverage spatial foundations to destabilize robotic actions, and a targeted attack objective that manipulates the robotic trajectory.
- Result cue: This paper systematically evaluates their robustness.

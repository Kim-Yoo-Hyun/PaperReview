...
- Abstract problem cue: Diffusion Policies have significantly advanced robotic manipulation tasks via imitation learning, but their application on resource-constrained mobile platforms remains challenging due to computational inefficiency ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Diffusion` 관점의 개선을 제안한다.

...
- tion estimation to reduce computational costs.
...
## Main Claims
- Extensive experiments and user studies demonstrate that our PhysSplat achieves more realistic motion than state-of-the-art methods within 2 minutes on a single GPU.
...
- Extensive experiments and user studies demonstrate that our PhysSplat achieves more realistic motion than state-of-the-art methods within 2 minutes on a single GPU.
- Inspired by human visual reasoning, we propose MLLMbased Physical Property Perception (MLLM-P3) to predict the mean physical properties of objects in a zero-shot manner.
- Introduction With the development in 3D representation, Neural Radiance Fields (NeRF) and 3D Gaussian Splatting (3DGS) offer new perspectives for 3D reconstruction and 3D representation .

...
- Abstract problem cue: Obtaining high-quality 3D semantic occupancy from raw sensor data remains an essential yet challenging task, often requiring extensive manual labeling.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `semantic occupancy, Vision-Language, Gaussian Splatting` 관점의 개선을 제안한다.

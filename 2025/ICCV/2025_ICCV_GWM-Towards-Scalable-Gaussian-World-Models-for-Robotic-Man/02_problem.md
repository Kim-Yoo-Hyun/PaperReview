...
- Abstract problem cue: The established image-based world models and policies have shown prior success, but lack robust geometric information that requires consistent spatial and physical understanding of ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, world model, Robotics` 관점의 개선을 제안한다.

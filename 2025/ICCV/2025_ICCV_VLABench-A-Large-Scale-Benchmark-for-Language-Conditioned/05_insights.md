...
- **Claim/result cue:** We demonstrate the superiority of our data framework through comparative experiments.
...
- **Registry interface:** `VLA, Benchmark, long-horizon` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Benchmarks and Datasets`; tags: `VLA, Benchmark, long-horizon`.

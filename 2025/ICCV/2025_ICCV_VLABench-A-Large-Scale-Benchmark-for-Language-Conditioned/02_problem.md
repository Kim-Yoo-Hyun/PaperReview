...
- Abstract problem cue: However, existing benchmarks do not adequately meet the needs of VLAs and relative algorithms.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, Benchmark, long-horizon` 관점의 개선을 제안한다.

...
- Abstract problem cue: However, existing methods struggle with disentangling targets from anchors in complex multi-anchor queries and resolving inconsistencies in spatial descriptions caused by perspective variations.To tackle ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Vision` 관점의 개선을 제안한다.

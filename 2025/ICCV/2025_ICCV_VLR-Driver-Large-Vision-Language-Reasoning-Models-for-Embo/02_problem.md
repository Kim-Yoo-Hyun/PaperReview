...
- Abstract problem cue: However, when confronted with intricate and ambiguous traffic scenarios, the lack of logical reasoning and cognitive decision-making capabilities remains the primary challenge impeding the ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model` 관점의 개선을 제안한다.

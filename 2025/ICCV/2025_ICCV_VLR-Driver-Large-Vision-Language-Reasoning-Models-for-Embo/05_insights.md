...
- **Method cue:** Our method was validated on the open source AD simulation platform CARLA 0.9.15 .
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: 자동 추출에서 명확한 dataset 단서 없음 / accuracy, SR, success rate, collision

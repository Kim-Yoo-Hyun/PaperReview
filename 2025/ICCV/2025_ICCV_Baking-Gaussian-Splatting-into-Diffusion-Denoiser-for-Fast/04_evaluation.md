...
- **p. 6 / 4. Experiment - extractive body cue:** Then we finetune the model on the object- and scene-level datasets with 64 A100 GPUs for 80K and 54K iterations at the per-GPU batch size ...
- **p. 6 / 4. Experiment - extractive body cue:** We adopt RealEstate10K [90] and DL3DV10K [36] as the scene-level training datasets.
- **p. 6 / Figure/Table caption - extractive body cue:** Figure 6. Visual comparison of single-view object generation on ABO, GSO, real-camera image, and text-to-image prompted by FLUX. Our method can generate more fine-grained details ...
...
- **p. 6 / 4. Experiment - extractive body cue:** The learning rate is linearly warmed up to 4e-4 with 2K iterations 25067
...
- **p. 5 / Figure/Table caption - extractive body cue:** Figure 5. Pl¨ucker ray vs. Reference-Point Pl¨ucker Coordinate. into non-overlapping tiles. The 3D Gaussians are assigned to the tiles where their 2D projections cover. For ...
- **p. 6 / Figure/Table caption - extractive body cue:** Figure 6. Visual comparison of single-view object generation on ABO, GSO, real-camera image, and text-to-image prompted by FLUX. Our method can generate more fine-grained details ...
- **p. 7 / Figure/Table caption - extractive body cue:** Table 1. User study and main quantitative results of single-view image-to-3D task on ABO [11], GSO [13], and Realestate10K [90].
...
- **p. 6 / 3.2. Scene-Object Mixed Training Strategy - extractive body cue:** 1iter≤iter0 and 1object are similar.
- **p. 7 / Method - extractive body cue:** Finally, we scale up the training resolution from 256×256 to 512×512 and finetune the model for 20K iterations.
...
- **Evidence anchors reviewed:** datasets p. 6 (4. Experiment), p. 6 (4. Experiment), metrics p. 6 (Figure/Table caption), p. 7 (Figure/Table caption), p. 6 (4. Experiment), p. 1 (Figure/Table caption), p. 2 (Figure/Table caption), p. 8 (Figure/Table caption), baselines p. 7 (Figure/Table caption), p. 6 (Figure/Table caption), p. 8 (Figure/Table caption), p. 8 (Figure/Table caption), results p. 7 (Figure/Table caption), p. 1 (Figure/Table caption), p. 2 (Figure/Table caption), p. 6 (Figure/Table caption), p. 7 (Figure/Table caption).

...
- Recently, the point-based method 3D Gaussian Splatting (3DGS) has emerged as an appealing alternative to those coordinate-based methods, thanks to its impressive images at high resolutions.

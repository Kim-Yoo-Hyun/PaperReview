...
## Dataset
Replica, Habitat, Open X-Embodiment, OXE
...
## Main Results
- Abstract result cue: Empirical evaluations across bimanual, dexterous, and long-horizon tasks show that Sim2Real-VLA consistently outperforms previous VLA baselines under diverse real-world environments and domain shifts.

...
- Abstract problem cue: However, these intermediate reasoning are often indirect and inherently limited in their capacity to convey the full, granular information required for precise action execution.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, Chain-of-Thought, Planning` 관점의 개선을 제안한다.

...
- Abstract problem cue: Existing VLG approaches focus on coarse-grained, object-level localization, while traditional robotic grasping methods rely predominantly on geometric cues and lack language guidance, which limits ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Visual-Language Grounding, Benchmark, Robotics` 관점의 개선을 제안한다.

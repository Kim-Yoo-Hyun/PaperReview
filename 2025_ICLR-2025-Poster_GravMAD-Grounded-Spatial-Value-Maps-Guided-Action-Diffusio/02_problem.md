...
- Abstract problem cue: However, these methods lack a task-specific learning process, which is essential for an accurate understanding of 3D environments, often leading to execution failures.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, 3D Vision, Diffusion, Imitation Learning` 관점의 개선을 제안한다.

...
- Abstract problem cue: However, even augmented with pre-trained models, these hierarchical policies still suffer from generalization issues.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, 3D Vision, Imitation Learning` 관점의 개선을 제안한다.

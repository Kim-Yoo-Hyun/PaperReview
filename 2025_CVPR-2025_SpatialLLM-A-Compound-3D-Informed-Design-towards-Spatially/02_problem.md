...
- Abstract problem cue: Current large multimodal models (LMMs), however, lack of this capability of 3D spatial reasoning.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `LLM, spatial reasoning, 3D Vision` 관점의 개선을 제안한다.

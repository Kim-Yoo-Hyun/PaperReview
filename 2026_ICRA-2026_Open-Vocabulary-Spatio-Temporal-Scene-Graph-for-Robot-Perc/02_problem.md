...
- Abstract problem cue: However, in dynamic remote scenes, transmission latency during bidirectional communication creates gaps between remote perceived states and operator intent, leading to command misunderstanding and ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Graph Reasoning, semantic` 관점의 개선을 제안한다.

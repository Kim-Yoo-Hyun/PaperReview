...
> Analysis basis: full-text PDF body checked on 2026-09-02 (8 pages; PyMuPDF text; title-token overlap first two pages=1.0); canonical paper source: https://doi.org/10.1115/1.3139652.
> PDF retrieval source: https://doi.org/10.1115/1.3139652. Reading tracker status/evidence was not changed.
...
- Full-text retrieval: https://doi.org/10.1115/1.3139652
...
|---|---|---|---|
| Observation/input | The actuator control signal for the /'th joint has N components - one for each force controlled degree of freedom in [C], and one for each position controlled degree of freedom: (2) ... | RGB-D/point cloud, object state와 contact/task observation | p. 3 (Front matter), p. 1 (Front matter) |
| State/latent | actuator, control, signal, joint, components, force, controlled, degree, freedom, position, where, torque | object geometry, affordance, contact mode 또는 end-effector state | p. 3 (Front matter), p. 1 (Front matter), p. 1 (Front matter) |
| Output/action | A number of methods for obtaining force information exist: motor currents may be measured or programmed, [6, 11], motor output torques may be measured [7], and wrist or hand mounted sensors may ... | grasp, pose, force 또는 end-effector trajectory | p. 1 (Front matter), p. 1 (Front matter), p. 3 (Front matter) |
| Objective/outcome | Manipulators of greater precision can be achieved only at the expense of size, weight, and cost. | task completion, contact success, pose/force error와 generalization | p. 1 (Front matter), p. 1 (Front matter), p. 2 (Front matter) |
...
- **p. 1 / Front matter - extractive body cue:** Such techniques are just now being developed.
- **p. 3 / Front matter - extractive body cue:** The present control methodology was designed to address this low-level control problem.
- **p. 4 / Front matter - extractive body cue:** To improve thermal immunity, gauges mounted on opposite faces are operated as voltage divider pairs [9J.
- **p. 5 / Front matter - extractive body cue:** Force control was achieved by combining proportional-integral (PI) control with a saturation-type feedback limiter and a simple feed forward term.
- **p. 6 / Front matter - extractive body cue:** Therefore, stability is more easily achieved.
- **p. 7 / Front matter - extractive body cue:** These changes resulted in improved force response -less overshoot and better stability - but did not affect the position servo perceptibly.
...
|---|---|---|---|
| Evaluation type | EMPIRICAL / SIMULATION | do not infer unreported downstream behavior | p. 4 (Front matter), p. 5 (Front matter) |
| Embodiment/environment | 5 Model used for simulation of hybrid control task 1 1 l-Kwwt -Acosfa,)] w2 = TT \-~K^w7. +Asin(<?i)l M3 Reaction surface model: fx=K,.(Cx CXf) Cx = ^cosfa,) + /sinfa,) (7) (8) (9) ... | hardware/simulator version and reset protocol | p. 5 (Front matter), p. 7 (Front matter) |
| Dataset/benchmark | It is an N degree of freedom Cartesian system defined with respect to the task geometry. | role, split, size and leakage | p. 5 (Front matter), p. 7 (Front matter), p. 2 (Front matter), p. 2 (Front matter) |
| Metric | As the manipulator moves, irregularities in the reaction surface and small errors in the accuracy of the position servo will look like surface motion to the force controller. | definition, denominator, direction and uncertainty | p. 7 (Front matter), p. 4 (Front matter), p. 3 (Front matter) |
| Baseline/ablation | Without this term the system was stable only when heavily overdamped. | fair input/data/compute/action matching | p. 6 (Front matter), p. 6 (Front matter), p. 6 (Front matter) |
...
Planning and control의 manipulation 문제를 이해하기 위해 읽는다. 본문은 The slow progress is due partly to a lack of rugged, reliable sensors of sufficient precision and versatility.를 문제로 두고, Note that the method we propose here does not prescribe particular feedback control laws for the regulation of errors.를 통해 observation-to-action closed loop의 한 지점을 바꾼다. Revisit p. 1 (Front matter), p. 1 (Front matter), p. 2 (Front matter), p. 2 (Front matter), p. 3 (Front matter), p. 4 (Front matter) to check whether the claimed mechanism survives the failure regime and evaluation boundary recorded above.

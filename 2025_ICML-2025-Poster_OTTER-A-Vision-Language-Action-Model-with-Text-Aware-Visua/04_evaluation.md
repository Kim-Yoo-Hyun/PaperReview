...
## Dataset
LIBERO, Open X-Embodiment, OXE, LAION
...
## Main Results
- Abstract result cue: In simulation and real-world experiments, OTTER significantly outperforms existing VLA models, demonstrating strong zero-shot generalization to novel objects and environments.

...
- **Claim/result cue:** Extensive experiments on both the KITTI dataset and the Waymo Open dataset show that our proposed PV-RCNN surpasses state-of-the-art 3D detection methods with remarkable margins by using only ...
...
- Registry position: `Autonomous 3D Perception and Sensor Fusion`; tags: `point cloud, 3D Vision`.

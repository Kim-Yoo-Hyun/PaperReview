...
- **Claim/result cue:** On standard bird’seye-view tasks such as object segmentation and map segmentation, our model outperforms all baselines and prior work.
...
- **Registry interface:** `3D Vision, BEV, sensor fusion, camera` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Autonomous 3D Perception and Sensor Fusion`; tags: `3D Vision, BEV, sensor fusion, camera`.

...
- **Claim/result cue:** Similar performance is achieved on the 3D metric (Table 2).
...
- **Registry interface:** `3D Vision, LiDAR, 3D detection, BEV` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Autonomous 3D Perception and Sensor Fusion`; tags: `3D Vision, LiDAR, 3D detection, BEV`.

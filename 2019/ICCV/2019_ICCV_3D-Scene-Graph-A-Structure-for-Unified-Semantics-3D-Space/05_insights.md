...
- **Registry interface:** `3D Scene Graph, semantic, geometry, Graph Reasoning` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Vision-Language Understanding`; tags: `3D Scene Graph, semantic, geometry, Graph Reasoning`.

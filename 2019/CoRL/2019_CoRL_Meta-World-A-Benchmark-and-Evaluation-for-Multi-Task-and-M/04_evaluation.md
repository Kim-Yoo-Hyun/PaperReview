...
- **p. 2 / 1 Introduction - extractive body cue:** By providing a large set of distinct tasks that share common environment and control structure, we believe that this benchmark will allow researchers to test ...
...
- **p. 12 / Figure/Table caption - extractive body cue:** Figure 6: Performance of independent policies trained on individual tasks using soft actor-critic (SAC) and proximal policy optimization (PPO). We verify that SAC can solve ...
...
- **p. 2 / Figure/Table caption - extractive body cue:** Figure 1: Meta-World contains 50 manipulation tasks, designed to be diverse yet carry shared structure that can be leveraged for efficient multi-task RL and transfer ...
...
- **p. 5 / Figure/Table caption - extractive body cue:** Figure 3: Visualization of three of our multi-task and meta-learning evaluation protocols, ranging from within task adaptation in ML1, to multi-task training across 10 distinct ...
- **p. 7 / Figure/Table caption - extractive body cue:** Figure 4: Comparison on our simplest meta-RL evaluation, ML1. We show results of the simplest meta-learning evaluation mode, ML1, in Figure 7. We find that ...
- **p. 8 / Figure/Table caption - extractive body cue:** Figure 5: Quantitative results on MT10, MT50, ML10, and ML45. Note that, even on the challenging ML10 and ML45 benchmarks, current methods already exhibit some ...
- **p. 11 / Figure/Table caption - extractive body cue:** Table 1: A list of all of the Meta-World tasks and a description of each task. B Task Rewards and Success Metrics The form of ...
- **p. 12 / Figure/Table caption - extractive body cue:** Figure 6: Performance of independent policies trained on individual tasks using soft actor-critic (SAC) and proximal policy optimization (PPO). We verify that SAC can solve ...
- **p. 12 / Figure/Table caption - extractive body cue:** Figure 6. We indeed find that SAC can learn to perform all of the 50 tasks to some degree, while PPO can solve a large ...

...
- Abstract problem cue: However current 3DSGG methods struggle with two main challenges.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Scene Graph, CLIP, Graph Reasoning` 관점의 개선을 제안한다.

...
- Abstract problem cue: However, it remains unclear how to formulate the constraints such that they are 1) versatile to diverse tasks, 2) free of manual labeling, and ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Planning, 3D geometry, Robotics, VLM` 관점의 개선을 제안한다.

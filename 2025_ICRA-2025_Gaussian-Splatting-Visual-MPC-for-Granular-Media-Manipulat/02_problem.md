...
- Abstract problem cue: However, manipulating granular materials such as beans, nuts, and rice, remains challenging due to the intricate physics of particle interactions, high-dimensional and partially observable ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Gaussian Splatting` 관점의 개선을 제안한다.

...
- Abstract problem cue: Robotic manipulation benefits from foundation models that describe goals, but today's agents still lack a principled way to learn from their own mistakes.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Reinforcement Learning` 관점의 개선을 제안한다.

...
- Abstract problem cue: However, current work has been mainly focused on indoor, household scenarios.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Robotics, Navigation, Reinforcement Learning` 관점의 개선을 제안한다.

...
- **Method cue:** We use a synthetic scene produced in a 3D rendering package.
...
- **Registry interface:** `3D Vision, SLAM, geometry, camera pose` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `3D Vision, SLAM, geometry, camera pose`.

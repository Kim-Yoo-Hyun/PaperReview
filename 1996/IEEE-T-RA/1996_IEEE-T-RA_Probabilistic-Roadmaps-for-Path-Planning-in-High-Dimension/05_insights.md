...
- Problem cue: UNVERIFIED — full-text close reading에서 paper-supported cue를 기록한다.
- Method cue: UNVERIFIED — full-text close reading에서 paper-supported cue를 기록한다.
...
`A Unified Approach for Motion and Force Control of Robot Manipulators: The Operational Space Formulation → Probabilistic Roadmaps for Path Planning in High-Dimensional Configuration Spaces → Rapidly-Exploring Random Trees: A New Tool for Path Planning`

...
- **Claim/result cue:** Reconstruction results of scenes captured using our live system are shown in Fig.
...
- **Registry interface:** `3D Vision, SLAM, RGB-D, 3D reconstruction` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `3D Vision, SLAM, RGB-D, 3D reconstruction`.

...
## 해결하려는 문제
- 연구 유형: sequence/representation learning
...
- Abstract problem cue: We show that the Transformer generalizes well to other tasks by applying it successfully to English constituency parsing both with large and limited training ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `LLM, Transformer, representation` 관점의 개선을 제안한다.

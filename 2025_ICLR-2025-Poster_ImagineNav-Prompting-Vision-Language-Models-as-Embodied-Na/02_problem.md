...
- Abstract problem cue: However, the planning process of LLMs is limited within texts and it is difficult to represent the spatial occupancy and geometry layout only by ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model, Robotics, Navigation` 관점의 개선을 제안한다.

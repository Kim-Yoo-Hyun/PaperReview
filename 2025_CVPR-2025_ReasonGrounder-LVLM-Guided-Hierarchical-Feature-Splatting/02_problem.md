...
- Abstract problem cue: However, current methods struggle because they rely heavily on fine-tuning with 3D annotations and mask proposals, which limits their ability to handle diverse semantics ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, grounding, LVLM` 관점의 개선을 제안한다.

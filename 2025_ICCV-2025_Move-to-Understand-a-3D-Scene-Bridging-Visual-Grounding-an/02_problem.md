...
- Abstract problem cue: Embodied scene understanding requires not only comprehending visual-spatial information that has been observed but also determining where to explore next in the 3D physical ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Navigation, grounding, exploration` 관점의 개선을 제안한다.

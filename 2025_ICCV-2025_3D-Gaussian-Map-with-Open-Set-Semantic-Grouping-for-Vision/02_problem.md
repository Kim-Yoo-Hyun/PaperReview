...
- Abstract problem cue: Vision-language navigation (VLN) requires an agent to traverse complex 3D environments based on natural language instructions, necessitating a thorough scene understanding.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Gaussian Splatting, Vision-Language Navigation, semantic` 관점의 개선을 제안한다.

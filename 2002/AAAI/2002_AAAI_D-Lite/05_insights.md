...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: To gain insight into its behavior, we present various theoretical properties of LPA* that also apply to D* Lite.
- 출발 문제 단서: Heuristic search methods, such as A* (Nilsson 1971), on the other hand, use heuristic knowledge in form of approximations of the goal distances to focus the search and ...
- 주장된 효과 단서: We believe that these results provide a strong foundation for further research on fast replanning methods in artificial intelligence and robotics.
...
- Result cue: We believe that these results provide a strong foundation for further research on fast replanning methods in artificial intelligence and robotics.

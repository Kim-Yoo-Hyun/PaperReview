...
- **p. 5 / Abstract - extractive PDF cue:** Real-world experiments were complimented by systematic simulation experiments, to investigate the scaling abilities of the approach.
- **p. 3 / Abstract - extractive PDF cue:** MCL is an application of particle filter to the problem of robot pose estimation (localization).
- **p. 3 / Abstract - extractive PDF cue:** This is a consequence of the use of sampling to approximate the distribution over the robot's pose.
- **p. 4 / Abstract - extractive PDF cue:** In such situations, the robot has to solve a data association problem between momentary landmarks sightings zt and the set of landmarks in the map ...
...
- **p. 5 / Abstract - extractive PDF cue:** The robot's estimates are indicated by x's, illustrating the high accuracy of the resulting maps.
...
- **p. 2 / Figure/Table caption - extractive PDF cue:** Figure 1: The SLAM problem: The robot moves from pose s1 through a sequence of controls, u1, u2, . . . , ut. As it ...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Figure 2: A tree representing K = 8 landmark estimates within a single particle. p(st,[m] / zt-1, ut, nt) p(st,[m] / zt-1, ut, nt) = ...
- **p. 4 / Figure/Table caption - extractive PDF cue:** Figure 3: Generating a new particle from an old one, while modi- fying only a single Gaussian. The new particle receives only a par- tial ...
- **p. 5 / Figure/Table caption - extractive PDF cue:** Figure 4: (a) Physical robot mapping rocks, in a testbed developed for Mars Rover research. (b) Raw range and path data. (c) Map generated using ...
- **p. 6 / Figure/Table caption - extractive PDF cue:** Figure 5: Maps and estimated robot path, generated using sensors with (a) large and (b) small perceptual fields. The correct landmark locations are shown as ...
- **p. 6 / Figure/Table caption - extractive PDF cue:** Figure 6: Accuracy of the FastSLAM algorithm as a function of (a) the number of landmarks N, and (b) the number of particles M. Large ...
...
- **p. 3 / Abstract - extractive PDF cue:** One significant difference between the FastSLAM algorithm's use of Kalman filters and that of the traditional SLAM algorithm is that the updates in the FastSLAM ...
- **p. 5 / Abstract - extractive PDF cue:** The resulting map generated with M = 10 samples is depicted in Figure 4c, with manually determined landmark locations marked by circles.
- **p. 5 / Abstract - extractive PDF cue:** FastSLAM resulted in an average residual map error of 8.3 centimeters, when compared to the manually generated map.
- **p. 3 / Abstract - extractive PDF cue:** One significant difference between the FastSLAM algorithm's use of Kalman filters and that of the traditional SLAM algorithm is that the updates in the FastSLAM ...
...
- **PDF anchors reviewed:** datasets p. 2 (Abstract), p. 2 (Abstract), p. 5 (Abstract), p. 3 (Abstract), p. 3 (Abstract), p. 4 (Abstract), metrics p. 6 (Figure/Table caption), p. 5 (Abstract), p. 5 (Abstract), p. 2 (Abstract), p. 2 (Abstract), p. 3 (Abstract), baselines p. 5 (Abstract), p. 2 (Abstract), results p. 6 (Figure/Table caption), p. 2 (Abstract), p. 5 (Abstract), p. 5 (Abstract).

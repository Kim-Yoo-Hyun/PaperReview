...
- **Claim/result cue:** Experimental results demonstrate the advantages and limitations of the FastSLAM algorithm on both simulated and realworld data.
...
- **Registry interface:** `Robotics, SLAM, particle filter, state estimation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `Robotics, SLAM, particle filter, state estimation`.

...
- **Claim/result cue:** ORBSLAM achieves unprecedented performance with respect to other state-of-the-art monocular SLAM approaches.
...
- **Registry interface:** `SLAM, calibration, geometry` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Geometry, Reconstruction, and SLAM`; tags: `SLAM, calibration, geometry`.

...
- Abstract problem cue: Whether VLMs can effectively leverage such multi-view inputs for robotic reasoning therefore remains an open question.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model, Robotics, 3D Vision, Benchmark` 관점의 개선을 제안한다.

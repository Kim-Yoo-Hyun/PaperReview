...
- Abstract problem cue: To tackle this challenge, the robot must capture and update scene changes and plans continuously.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Navigation, Graph Reasoning, semantic` 관점의 개선을 제안한다.

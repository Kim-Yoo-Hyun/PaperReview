...
- Abstract problem cue: Real-world deployment requires open vocabulary generalization and low training overhead, motivating zero-shot methods rather than task-specific RL training.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Scene Graph, Navigation, zero-shot` 관점의 개선을 제안한다.

...
- Abstract problem cue: Existing methods for 3D SSG generation, however, face significant challenges, including high computational demands and non-incremental processing that hinder their suitability for real-time open-world ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `3D Vision, Graph Reasoning, semantic` 관점의 개선을 제안한다.

...
- **Registry interface:** `Diffusion, guidance, Generation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Foundations: Generative Models`; tags: `Diffusion, guidance, Generation`.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: In this paper, we develop position embedding transformation (PETR) for multi-view 3D object detection.
- 출발 문제 단서: Previous works mainly solved this problem from the perspective of monocular object detection.
- 주장된 효과 단서: PETR achieves state-of-the-art performance (50.4% NDS and 44.1% mAP) on standard nuScenes dataset and ranks 1st place on the benchmark.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: PETR achieves state-of-the-art performance (50.4% NDS and 44.1% mAP) on standard nuScenes dataset and ranks 1st place on the benchmark.
- 저자가 남긴 확장 방향: It achieves state-of-the-art performance and can serve as a strong baseline for future research.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: nuScenes / mAP, NDS, SR
...
## 근거가 되는 논문 단서
- Problem cue: Previous works mainly solved this problem from the perspective of monocular object detection.

...
- **Claim/result cue:** OpenSeg significantly outperforms the recent openvocabulary method of LSeg by +19.9 mIoU on PASCAL dataset, thanks to its scalability. bride groom hills field sky cow calf grass trees ...
...
- **Registry interface:** `Vision-Language Model, semantic, open-vocabulary, segmentation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Embodied Navigation and Mapping`; tags: `Vision-Language Model, semantic, open-vocabulary, segmentation`.

...
- **Method cue:** Assuming that ni is the number of classes in fold i, for each fold i, we use images of other folds for training and randomly sampled 1000 images ...
...
- **Registry interface:** `Vision-Language Model, semantic, open-vocabulary, alignment` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Embodied Navigation and Mapping`; tags: `Vision-Language Model, semantic, open-vocabulary, alignment`.
...
- **Protocol carried forward from the legacy note (candidate, not a verified paper evaluation):**
  - 논문 내 evaluation 단서: ImageNet, COCO / accuracy, mIoU, IoU, mAP

...
- **Claim/result cue:** We show that a baseline model based on multi-context imitation learning performs poorly on CALVIN, suggesting that there is significant room for developing innovative agents that learn to ...
...
- **Registry interface:** `Vision-Language Action, Benchmark, Robotics` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Benchmarks and Datasets`; tags: `Vision-Language Action, Benchmark, Robotics`.

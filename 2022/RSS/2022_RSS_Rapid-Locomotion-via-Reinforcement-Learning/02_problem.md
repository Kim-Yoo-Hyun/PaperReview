...
| Observation / input | Our goal is to learn a policy πθ(.) with parameters θ that takes as input sensory data and velocity commands and gives ... | proprioception, terrain/perception observation과 velocity command | exact sensor/frame/preprocessing from PDF body |
...
| Decision / output variable | joint action/torque/footstep; body terms: end-to-end, learned, controller, enables, MIT, Mini, Cheetah, execute | p. 1 (I. INTRODUCTION), p. 2 (I. INTRODUCTION), p. 3 (III. METHOD) |
...
PDF body contribution framing (p. 1 (I. INTRODUCTION), p. 2 (I. INTRODUCTION), p. 3 (III. METHOD), p. 2 (I. INTRODUCTION), p. 1 (I. INTRODUCTION)): 1: An end-to-end learned controller enables the MIT Mini Cheetah to execute: (a) fast sprinting at 3.9 m/s (top); (b) a rough terrain 10-meter sprint at 3.4 m/s; (c) high-speed ...
...
locomotion writing domain maps to observation -> state/world model -> task and motion decision -> policy/control -> feedback. Evidence interface anchors: p. 2 (III. METHOD), p. 2 (III. METHOD), p. 3 (III. METHOD), p. 1 (I. INTRODUCTION). The downstream handoff is claimed only when the body describes it.

## Verification Questions

- **Evidence anchors reviewed:** problem p. 2 (I. INTRODUCTION), p. 2 (I. INTRODUCTION), p. 1 (I. INTRODUCTION), p. 1 (I. INTRODUCTION), interface p. 2 (III. METHOD), p. 2 (III. METHOD), p. 3 (III. METHOD), p. 1 (I. INTRODUCTION), objective p. 3 (III. METHOD).

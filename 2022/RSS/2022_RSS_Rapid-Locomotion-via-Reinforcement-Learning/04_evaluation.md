...
- **p. 6 / IV. RESULTS - extractive body cue:** The maximum attainable speed is intimately tied to the robot's hardware properties, such as its weight, motor strength, and leg length.
...
- **p. 2 / II. EXPERIMENTAL SETUP - extractive body cue:** The robot stands 30 cm tall and weighs 9 kg.
- **p. 2 / II. EXPERIMENTAL SETUP - extractive body cue:** Hardware: We use the MIT Mini Cheetah [20] as our experimental platform.
- **p. 6 / IV. RESULTS - extractive body cue:** On the other hand, some aspects of the real-world dynamics are probably not captured under any configuration of the simulator.
- **p. 7 / IV. RESULTS - extractive body cue:** The privileged teacher πT trained with access to environment parameters attains a strictly larger command area than the policy πDR trained with only the robot ...
...
- **p. 5 / IV. RESULTS - extractive body cue:** Curriculum Learning Enables High-Speed Locomotion Figure 3(a) visualizes the tracking error (see Section III-E) of the policies learned from the three command sampling strategies as ...
...
- **p. 2 / Figure/Table caption - extractive body cue:** Fig. 2: Our controller is a learned mapping from sensory inputs to desired joint positions. We parameterize it as 5-layer neural network πθ with parameters ...
- **p. 5 / Figure/Table caption - extractive body cue:** Fig. 3: (a) Forward and angular velocity tracking performance. The Grid Adaptive curriculum tracks a larger range of velocities than the Box Adaptive curriculum for ...
- **p. 7 / Figure/Table caption - extractive body cue:** Fig. 4: Online system identification reduces tracking error, particularly at high speeds. The command area increases as the error threshold is relaxed for teacher, student, ...
- **p. 7 / Figure/Table caption - extractive body cue:** Fig. 5: (a) Increasing the magnitude of terrain roughness during training shrinks the range of commands the robot can successfully track - the command area ...
...
|---|---|---|---|
| 1: An end-to-end learned controller enables the MIT Mini Cheetah to execute: (a) fast sprinting at 3.9 m/s (top); (b) a rough terrain 10-meter ... | The performance of the system is improved substantially by implementing the Box Curriculum. | PDF body cue; verify exact table/figure and matched conditions | p. 6 (IV. RESULTS), p. 6 (IV. RESULTS), p. 7 (IV. RESULTS), p. 7 (IV. RESULTS), p. 5 (Figure/Table caption) |
...
- **p. 2 / II. EXPERIMENTAL SETUP - extractive body cue:** Our neural network controller runs at 50 Hz on an onboard NVIDIA Jetson TX2 NX computer.
- **p. 2 / II. EXPERIMENTAL SETUP - extractive body cue:** This is roughly equivalent to 92 real-time days, which we can simulate in under three hours of wall-clock time using a single NVIDIA RTX 3090 ...
- **p. 6 / IV. RESULTS - extractive body cue:** This is higher than the previous record of 3.7 m/s reported for a vcmd x vx (Sim) vx (Real) With System ID (πθST ) 6.0 ...
...
- **Evidence anchors reviewed:** datasets p. 6 (IV. RESULTS), p. 7 (IV. RESULTS), p. 2 (II. EXPERIMENTAL SETUP), p. 2 (II. EXPERIMENTAL SETUP), p. 6 (IV. RESULTS), p. 7 (IV. RESULTS), metrics p. 5 (Figure/Table caption), p. 5 (IV. RESULTS), p. 6 (IV. RESULTS), p. 7 (Figure/Table caption), p. 6 (IV. RESULTS), p. 7 (IV. RESULTS), baselines p. 7 (IV. RESULTS), p. 6 (IV. RESULTS), p. 6 (IV. RESULTS), p. 7 (IV. RESULTS), results p. 6 (IV. RESULTS), p. 6 (IV. RESULTS), p. 7 (IV. RESULTS), p. 7 (IV. RESULTS), p. 5 (Figure/Table caption).

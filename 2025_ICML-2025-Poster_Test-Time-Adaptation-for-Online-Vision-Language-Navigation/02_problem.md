...
- Abstract problem cue: Navigating in an unfamiliar environment during deployment poses a critical challenge for a vision-language navigation (VLN) agent.
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `Vision-Language Model, Navigation, Reinforcement Learning` 관점의 개선을 제안한다.

...
- **Claim/result cue:** We achieve state-of-the-art performance on the nuScenes autonomous driving benchmark.
...
- **Registry interface:** `3D Vision, BEV, 3D detection, camera` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Autonomous 3D Perception and Sensor Fusion`; tags: `3D Vision, BEV, 3D detection, camera`.

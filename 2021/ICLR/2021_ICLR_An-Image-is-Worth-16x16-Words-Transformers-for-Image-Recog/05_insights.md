...
- **Registry interface:** `Vision Transformer, representation` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `Foundations: Vision and Language Models`; tags: `Vision Transformer, representation`.

...
- **Claim/result cue:** We validate that our 3DVG-Transformer outperforms the state-of-the-art methods by a large margin, on two point cloud-based visual grounding datasets, ScanRefer and Nr3D/Sr3D from ReferIt3D, especially for complex ...
...
- **Registry interface:** `3D visual grounding, Graph Reasoning, Transformer` is the paper's recorded topic/interface, not evidence that the full robotics loop was evaluated.
...
- Registry position: `3D Vision-Language Understanding`; tags: `3D visual grounding, Graph Reasoning, Transformer`.

...
## 이 논문에서 가져갈 핵심 개념
- 핵심 방법 단서: We introduce DROID-SLAM, a new deep learning based SLAM system.
- 출발 문제 단서: The SLAM problem has been approached from a number of different angles.
- 주장된 효과 단서: Despite training on monocular video, it can leverage stereo or RGB-D video to achieve improved performance at test time.
...
## 이 논문이 끝난 지점
- 논문이 도달한 지점: Despite training on monocular video, it can leverage stereo or RGB-D video to achieve improved performance at test time.
...
## 실험으로 확인할 방향
- 논문 내 evaluation 단서: ScanNet, ETH3D, EuRoC / accuracy, mAP, ATE
...
- Result cue: Despite training on monocular video, it can leverage stereo or RGB-D video to achieve improved performance at test time.

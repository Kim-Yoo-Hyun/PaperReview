...
- Abstract problem cue: Current Vision-Language-Action (VLA) models primarily focus on mapping 2D observations to actions but exhibit notable limitations in spatiotemporal perception and reasoning: 1) spatial representations ...
...
- 이 논문은 두 축을 결합하는 흐름 안에서, `VLA, consistency, 4D reasoning` 관점의 개선을 제안한다.
